    ...
    while eligible_operations:
        ...
        for job, op_num in eligible_operations:
            ...
            for m_idx, m in enumerate(machines):
                ...
                # Combine load and shortest time for evaluation
                priority = start_time + times[m_idx] + machine_load[m]  # Load included
                if priority < earliest_start:
                    earliest_start = priority
                    best_op = op_num
                    best_machine = m
        ...
        machine_load[best_machine] += best_time # Add load to best_machine

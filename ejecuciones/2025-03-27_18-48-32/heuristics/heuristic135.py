...
def heuristic(input_data):
    """FJSSP heuristic: SPT with dynamic load balancing."""
    ...
    for job_id in jobs:
        ...
        for op_idx, operation in enumerate(jobs[job_id]):
            ...
            for machine in possible_machines:
                ...
                load_weight = 1 + (machine_load[machine] / sum(machine_load.values()) if sum(machine_load.values()) > 0 else 0)
                weighted_time = end_time * load_weight

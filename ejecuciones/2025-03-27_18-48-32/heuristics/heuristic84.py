...
def heuristic(input_data):
    """Minimize makespan via longest processing time and load balancing."""
    ...
    while any(remaining_operations.values()):
        ...
        # Prioritize longest processing time
        eligible_operations.sort(key=lambda x: max(x[3]), reverse=True)

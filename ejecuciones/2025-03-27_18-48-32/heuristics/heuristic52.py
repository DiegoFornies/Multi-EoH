...
def heuristic(input_data):
    """Balances makespan and machine load using a combined approach."""
    ...
    while eligible_operations:
        ...
        for job, op_num in eligible_operations:
            ...
            # Combined heuristic: considers both processing time and machine load
            ...
            for m_idx, m in enumerate(machines):
                ...
                # Penalize machines with higher load (adjust penalty factor as needed)

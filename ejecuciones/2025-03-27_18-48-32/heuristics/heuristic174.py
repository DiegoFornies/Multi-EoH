...
def heuristic(input_data):
    """FJSSP heuristic: SPT with EDD and dynamic machine load."""
    ...
    while eligible_operations:
        ...
        for job, op_num in eligible_operations:
            ...
            for m_idx, m in enumerate(machines):
                ...
                # Dynamic priority: consider machine load, job urgency (EDD)
                load_penalty = machine_load[m] * 0.025
                urgency_bonus = (job_due_time[job] - job_completion_times[job]) * 0.01

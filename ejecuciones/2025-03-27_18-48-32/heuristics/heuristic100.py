...
def heuristic(input_data):
    """
    Prioritizes operations based on shortest processing time and machine load,
    balancing makespan and machine utilization.
    """
    ...
    while eligible_operations:
        #Prioritizes operations based on machine load and processing time
        best_op = None
        ...
        for job, op_num in eligible_operations:
            ...
            for m_idx, m in enumerate(machines):
                ...
                priority = times[m_idx] + machine_load[m]  #Balance processing time and machine load
        ...
        machine_load[best_machine] += best_time # Updates machine load

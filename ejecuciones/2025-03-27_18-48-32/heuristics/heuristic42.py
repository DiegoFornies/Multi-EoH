...
def heuristic(input_data):
    ...
    while any(remaining_operations.values()):
        ...
        # Select the operation with the best score based on makespan and machine load.
        best_operation = None
        ...
        for job, op_num, machines, times in eligible_operations:
            for m_idx, m in enumerate(machines):
                ...
                # Score combines makespan and machine load
                score = end_time + 0.1 * machine_load # Adjust weight to balance these

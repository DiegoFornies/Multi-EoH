...
def heuristic(input_data):
    """Combines shortest processing time with dynamic urgency adjustments and EDD."""
    ...
    while eligible_operations:
        ...
        for job, op_num in eligible_operations:
            ...
            for m_idx, m in enumerate(machines):
                ...
                # Dynamic priority: consider job urgency using EDD.
                urgency = job_due_dates[job] - job_completion_times[job]
                urgency_bonus = max(0, 1 - (urgency / job_due_dates[job]))

                adjusted_start_time = start_time - urgency_bonus

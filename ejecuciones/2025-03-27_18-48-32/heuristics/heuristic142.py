...
def heuristic(input_data):
    """Combines shortest processing time & load balancing for FJSSP."""
    ...
    while eligible_operations:
        ...
        for job, op_num in eligible_operations:
            ...
            for m_idx, m in enumerate(machines):
                ...
                load_factor = len(machine_assignments[m]) * 0.1  # Adjust weight
                weighted_end_time = end_time + load_factor # Apply Penalty

                if weighted_end_time < earliest_start:
                    earliest_start = weighted_end_time
                    best_op = op_num
                    best_machine = m
        ...
        machine_assignments[best_machine].append(best_job)

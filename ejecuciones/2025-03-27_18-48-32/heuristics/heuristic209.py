...
def heuristic(input_data):
    """Schedules jobs, balances makespan, and reduces idle time."""
    ...
    while eligible_operations:
        ...
        for job, op_num in eligible_operations:
            ...
            for m_idx, m in enumerate(machines):
                ...
                # Prioritize jobs with shorter processing times and earlier due dates
                priority = times[m_idx]  # Shorter processing time preferred

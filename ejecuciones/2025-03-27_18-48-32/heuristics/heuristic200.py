    ...
    while eligible_operations:
        ...
        for job, op_num in eligible_operations:
            ...
            for m_idx, m in enumerate(machines):
                ...
                # Load balancing: Add a small penalty to machines that are already busy
                machine_load = machine_available_times[m]
                
                #Prioritizing lighter loaded machine
                load_penalty = machine_load * 0.001  # Adjust factor as needed

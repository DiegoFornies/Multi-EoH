...
def heuristic(input_data):
    """Schedules jobs by balancing makespan and machine load dynamically."""
    ...
    while eligible_operations:
        ...
        for job, op_num in eligible_operations:
            ...
            for m_idx, m in enumerate(machines):
                ...
                # Dynamic load balancing: prefer lightly loaded machines
                load_factor = 1 + (machine_load[m] / sum(machine_load.values()) if sum(machine_load.values()) > 0 else 0)

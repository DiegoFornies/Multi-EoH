...
def heuristic(input_data):
    """Schedules jobs balancing makespan, load, and urgency."""
    ...
    while eligible_operations:
        ...
        for job, op_num in eligible_operations:
            ...
            for m_idx, m in enumerate(machines):
                ...
                adjusted_load_penalty = load_penalty * (1 - urgency_factor)
                adjusted_start_time = start_time + adjusted_load_penalty

...
def heuristic(input_data):
    """Heuristic combining SPT, load balancing, and job urgency."""
    ...
    while eligible_operations:
        ...
        for job, op_num in eligible_operations:
            ...
            for m_idx, m in enumerate(machines):
                ...
                # Dynamic priority: machine load and job urgency
                load_penalty = machine_load[m] * 0.05
                urgency_bonus = job_completion_times[job] / (sum(machine_load.values()) + 1e-9)

...
def heuristic(input_data):
    """
    A heuristic for the FJSSP problem that prioritizes shortest processing time
    ...
    while eligible_operations:
        # Find the operation with the shortest possible processing time from available operations.
        best_op = None
        ...
        machine_assignments[job_id].append((op_num, machine))

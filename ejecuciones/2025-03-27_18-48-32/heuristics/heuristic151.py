...
def heuristic(input_data):
    """FJSSP heuristic: Blends load balancing with job urgency."""
    ...
    while eligible_operations:
        ...
        for job, op_num in eligible_operations:
            ...
            for m_idx, m in enumerate(machines):
                ...
                load_penalty = machine_load[m] * 0.01 # Adjust load penalty
                urgency_bonus = job_completion_times[job] * 0.005 # Adjust urgency

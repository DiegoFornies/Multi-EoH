...
def heuristic(input_data):
    """Combines EDD and machine load for FJSSP."""
    ...
    while any(remaining_operations.values()):
        ...
        # Prioritize by EDD and machine load
        ...
        best_machine = min(machines, key=lambda m: machine_available_time[m] + machine_load[m] * 0.1)

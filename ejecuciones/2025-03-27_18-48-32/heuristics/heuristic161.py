...
def heuristic(input_data):
    """Combines shortest processing time and load balancing."""
    ...
    while eligible_operations:
        ...
        for job, op_num in eligible_operations:
            ...
            for m_idx, m in enumerate(machines):
                ...
                # Prioritize machine with lowest load if start times are close
                load_factor = machine_load[m] * 0.01 # scale parameter
                start_time_with_load = start_time + load_factor
                
                if start_time_with_load < earliest_start:
                    earliest_start = start_time_with_load
                    best_op = op_num
                    best_machine = m

...
def heuristic(input_data):
    """
    FJSSP heuristic: SPT, machine load, random tie-breaking.
    """
    ...
    while available_operations:
        ...
        available_operations.sort(key=lambda op: (min(op['times']), machine_available_time[op['machines_available'][op['times'].index(min(op['times']))]]))

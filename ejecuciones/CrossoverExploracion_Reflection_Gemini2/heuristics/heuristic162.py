...
def heuristic(input_data):
    """FJSSP heuristic: SPT, machine load, and job dependencies."""
    ...
    while available_operations:
        # Adaptive Priority: SPT + Machine Load + Job Wait Time
        def operation_priority(op):
            ...
            job_wait_time = job_completion_time[op['job_id']]
            # Prioritize short jobs, less loaded machines, and longer wait times.
            return min_time + 0.1 * avg_machine_load - 0.05 * job_wait_time

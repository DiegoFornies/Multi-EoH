...
def heuristic(input_data):
    ...
    while available_operations:
        ...
        for i in range(len(machines)):
            ...
            # Incorporate machine load into the selection.
            # Prefer machines with lower load to balance the schedule.
            weighted_end_time = end_time + machine_load/100  # Tweak this weighting for best balance

...
def heuristic(input_data):
    """Combines SPT, machine availability, job remaining operations, and load balancing."""
    ...
    while available_operations:
        # Prioritize jobs with fewer remaining operations, SPT, and machine load.
        available_operations.sort(key=lambda op: (job_remaining_operations[op['job_id']], min(op['times']), min([machine_available_time[m] for m in op['machines']])))

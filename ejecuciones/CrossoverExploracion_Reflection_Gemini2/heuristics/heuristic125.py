...
def heuristic(input_data):
    """Heuristic for FJSSP: Combines SPT, machine load, and job dependencies dynamically."""
    ...
    while available_operations:
        ...
        def operation_priority(op):
            ...
            if best_machine is None:
                return float('inf')
            return min_time * load_weights[best_machine] + 0.01* job_completion_time[op['job_id']]

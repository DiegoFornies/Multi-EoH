...
def heuristic(input_data):
    """
    Combines SPT, earliest machine availability, and dynamic load balancing.
    """
    ...
    while available_operations:
        def operation_priority(op):
            """Calculates priority score based on SPT, machine availability, and load."""
            job_id = op['job_id']
            ...
            for i in range(len(machines)):
                ...
                priority = time + start_time + machine_load[machine] * 0.5 #SPT + availability + load

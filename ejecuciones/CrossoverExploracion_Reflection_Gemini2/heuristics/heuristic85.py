...
def heuristic(input_data):
    """Combines SPT, machine load, and job dependencies for FJSSP."""
    ...
    while available_operations:
        # Priority: Combines SPT and Machine Load + job completion time.
        def operation_priority(op):
            ...
            job_ready = job_completion_time[op['job_id']]
            return min_time + 0.1 * avg_machine_load + 0.05 * job_ready

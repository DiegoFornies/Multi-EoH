...
def heuristic(input_data):
    """Schedules jobs minimizing makespan using SPT and machine load."""
    ...
    while available_operations:
        # Sort available operations by SPT and machine availability.
            ...
            if op['op_idx'] == job_current_operation[op['job_id']]:
                ...
                for job_schedule in schedule.values():
                    for scheduled_op in job_schedule:
                        if scheduled_op['Operation'] == op['op_idx'] and scheduled_op['Assigned Machine'] == op['machines'][0]:
                            is_scheduled = True
                            break
                    if is_scheduled:
                        break

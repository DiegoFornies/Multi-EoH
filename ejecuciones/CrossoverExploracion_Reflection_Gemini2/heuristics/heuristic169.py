...
def heuristic(input_data):
    """
    Combines SPT and machine load balancing with dynamic weight adjustment.
    Prioritizes operations based on a weighted score.
    """
    ...
    while available_operations:
        ...
        if makespan > 100:
            spt_weight -= 0.05
            load_weight += 0.05
            spt_weight = max(0.2, spt_weight)
            load_weight = min(0.8, load_weight)

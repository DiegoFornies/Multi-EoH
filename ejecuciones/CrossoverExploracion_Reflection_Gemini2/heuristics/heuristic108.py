...
def heuristic(input_data):
    """
    Combines SPT, machine load, and remaining operations for FJSSP.
    Dynamically prioritizes operations based on multiple factors.
    """
    ...
    while available_operations:
        # Adaptive Priority: SPT, Machine Load, Remaining Operations
        def operation_priority(op):
            ...
            remaining_ops = job_remaining_operations[op['job_id']]
            # Combine factors: shorter time, less loaded, fewer remaining ops
            return (min_time + 0.1 * avg_machine_load + 0.05 * remaining_ops)

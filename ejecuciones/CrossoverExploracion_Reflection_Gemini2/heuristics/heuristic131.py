...
def heuristic(input_data):
    """
    Hybrid heuristic: SPT, machine load, and separation time for FJSSP.
    """
    ...
    while available_operations:
        # Prioritize SPT, balance machine load, and add separation time.
        ...
        for i in range(len(machines)):
            ...
            start_time = max(available_time, job_completion_time[job_id] + separation_time if op_idx > 1 else job_completion_time[job_id])
        ...
        start_time = max(machine_available_time[best_machine], job_completion_time[job_id] + separation_time if op_idx > 1 else job_completion_time[job_id])

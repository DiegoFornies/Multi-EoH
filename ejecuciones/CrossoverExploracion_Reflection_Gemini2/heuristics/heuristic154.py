...
def heuristic(input_data):
    """
    A heuristic for FJSSP minimizing makespan.
    Prioritizes operations based on job urgency and machine load.
    """
    ...
    while available_operations:
        #Prioritize most urgent job operations
        available_operations.sort(key=lambda op: (job_completion_time[op['job_id']]))
        ...
        # Find the best machine that finish the operation

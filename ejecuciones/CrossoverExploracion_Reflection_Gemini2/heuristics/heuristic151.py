...
def heuristic(input_data):
    """
    Combines SPT, machine load, job remaining ops for FJSSP.
    """
    ...
    while available_operations:
        ...
        def operation_key(op):
            ...
            remaining_ops_factor = job_remaining_operations[op['job_id']]
            return min_time * load_factor + remaining_ops_factor

...
def heuristic(input_data):
    """Schedules jobs using SPT, machine availability, and load balancing."""
    ...
    while available_operations:
        ...
        available_operations.sort(key=lambda op: (job_remaining_operations[op['job_id']],
                                                   min(op['times']),
                                                   min([machine_available_time[m] for m in op['machines']])))

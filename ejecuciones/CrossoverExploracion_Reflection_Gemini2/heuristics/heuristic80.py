...
def heuristic(input_data):
    """
    A heuristic to solve the FJSSP. Combines SPT, machine load, and job dependencies.
    Dynamically adapts priorities to balance makespan, separation, and balance.
    """
    ...
    while available_operations:
        # Adaptive Priority: Combines SPT and Machine Load.
        # Prioritize operations with shorter processing times on less loaded machines.
        def operation_priority(op):
            ...
            #Combines shortest processing time and machine load balance
            return min_time + 0.1 * avg_machine_load # adjust weights as needed

...
def heuristic(input_data):
    """
    Combines SPT and EFT for FJSSP scheduling.
    Prioritizes shortest processing time but considers earliest finish time.
    """
    ...
    while available_operations:
        ...
        #First, sort the available operations by shortest processing time.

...
def heuristic(input_data):
    """Combines SPT, machine availability, and dynamic job priority,
    with load balancing consideration.
    """
    ...
    while available_operations:
        # Sort by jobs with fewer operations, shortest processing time, and machine load

...
def heuristic(input_data):
    """Schedules jobs using a hybrid SPT and Earliest Finish Time heuristic."""
    ...
    while available_operations:
        def operation_priority(op):
            ...
            for i, machine in enumerate(op['machines']):
                ...
                possible_end_times.append(start_time + op['times'][i])
            return min_time, min(possible_end_times) # SPT and Earliest Finish Time

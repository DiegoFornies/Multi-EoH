...
def heuristic(input_data):
    """Combines load balancing with SPT and job urgency."""
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for operation_index, operation_data in enumerate(job_operations):
            ...
            # Sort machines by load.
            machine_load_subset = {m: machine_load[m] for m in possible_machines}
            sorted_machines = sorted(machine_load_subset, key=machine_load_subset.get)

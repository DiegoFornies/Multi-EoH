...
def heuristic(input_data):
    """Operation-centric, bottleneck avoidance with makespan optimization."""
    ...
    operations.sort() # Sort operations based on their shortest processing time

    for _, job_id, operation_index, machines, times in operations:
        best_machine = None

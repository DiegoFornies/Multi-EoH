...
def heuristic(input_data):
    ...
    while available_operations:
        # Prioritize operations based on load balancing, shortest processing time, and earliest start time
        best_op = None
        ...
        for op_data in available_operations:
            ...
            # Find the best machine considering load and earliest start
            ...
            #Prioritizing based on the earliest start time and lower processing time.
            #Also considering machine load
            if (earliest_start_time < best_start_time) or \
               (earliest_start_time == best_start_time and processing_time < best_processing_time) or \
               (earliest_start_time == best_start_time and processing_time == best_processing_time and machine_load[selected_machine] < best_machine_load):
                ...
                best_machine_load = machine_load[selected_machine]

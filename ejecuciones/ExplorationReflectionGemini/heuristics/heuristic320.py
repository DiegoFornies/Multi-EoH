...
def heuristic(input_data):
    """Dynamic priority heuristic balancing makespan and machine load."""
    ...
    while available_operations:
        # Dynamic priority: balance SPT and machine load
        best_op = None
        ...
        for op_data in available_operations:
            ...
            # Calculate a priority based on processing time and machine load
            machine_load = machine_available_times[best_machine] #Current machine load. Lower values indicate it's more free.
            processing_time = best_time
            priority = processing_time + 0.5 * machine_load  # Adjust weights for balance

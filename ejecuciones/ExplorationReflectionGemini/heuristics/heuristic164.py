...
def heuristic(input_data):
    """FJSSP heuristic: Combines SPT, EST, and load balancing for scheduling."""
    ...
    for job in jobs:
        ...
        for op_idx, operation in enumerate(jobs[job]):
            ...
            for i, machine in enumerate(machines):
                ...
                # Combine EST, SPT, and load balancing
                load_balance_factor = machine_load[machine]
                combined_metric = start_time + processing_time + 0.05 * load_balance_factor

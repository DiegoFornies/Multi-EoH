...
def heuristic(input_data):
    """
    Combines earliest availability with dynamic machine preference based on workload and SPT.
    """
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for operation_index, operation_data in enumerate(job_operations):
            ...
            for i, machine in enumerate(possible_machines):
                ...
                # Dynamic weight between completion time & machine load & SPT
                combined_metric = end_time + 0.1 * machine_load[machine] + 0.01 * processing_time

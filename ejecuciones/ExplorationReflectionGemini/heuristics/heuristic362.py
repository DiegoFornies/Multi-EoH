...
def heuristic(input_data):
    """FJSSP heuristic: Combines SPT, load balance, and job completion."""
    ...
    while available_operations:
        ...
        for op_data in available_operations:
            ...
            score = 0.5 * (earliest_start_time + processing_time) + 0.3 * machine_load + 0.2 * job_completion_times[job_id]

...
def heuristic(input_data):
    """
    A heuristic for the FJSSP that minimizes makespan, reduces idle time, and balances machine load.
    It prioritizes operations based on shortest processing time and machine availability.
    """
    ...
    # Prioritize operations by shortest processing time

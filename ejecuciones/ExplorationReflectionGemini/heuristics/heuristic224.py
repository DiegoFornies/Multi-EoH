...
def heuristic(input_data):
    """Balances earliest availability and machine load adaptively."""
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for operation_index, operation_data in enumerate(job_operations):
            ...
            for i in range(len(possible_machines)):
                ...
                # Adaptive weighting: prioritize load balancing early, makespan later
                load_weight = 0.2 if job_completion_times[job_id] < 100 else 0.05 # Example threshold
                weighted_time = end_time + load_weight * machine_load[machine]

...
def heuristic(input_data):
    """Dynamically adjust SPT/earliest availability/load balancing."""
    ...
    for job in range(1, n_jobs + 1):
        ...
        for op_idx, operation in enumerate(jobs[job]):
            ...
            for i, machine in enumerate(machines):
                ...
                # Dynamic weights: SPT, Earliest Availability, Load Balance
                spt_weight = 0.4 #SPT Weight
                avail_weight = 0.3 #Earliest availabilty weight
                load_weight = 0.3 #Load balance weight

                combined_metric = spt_weight * completion_time + avail_weight * available_time + load_weight * machine_load[machine]

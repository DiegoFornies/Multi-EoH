...
def heuristic(input_data):
    ...
    Chooses machine with earliest availability and load,
    adding a small penalty to encourage workload balance.
    """
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for op_idx, operation_data in enumerate(job_operations):
            ...
            for i in range(len(possible_machines)):
                ...
                weighted_time = end_time + 0.05 * machine_load[machine]  # Balance makespan & load
                # Prioritize lower loaded machines

...
def heuristic(input_data):
    """
    A hybrid heuristic balancing makespan and machine load.
    Selects machine based on earliest availability and load.
    """
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for operation_index, operation_data in enumerate(job_operations):
            ...
            for i in range(len(possible_machines)):
                ...
                # Prioritize machines with lower load (balance) and earlier completion

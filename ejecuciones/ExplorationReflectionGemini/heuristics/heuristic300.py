...
def heuristic(input_data):
    """Schedules jobs considering job urgency and machine load balancing."""
    ...
    for job_id, operations in jobs.items():
        ...
        for machines, times in operations:
            total_time += min(times)  # Use shortest processing time for estimation
    ...
    while available_operations:
        ...
        for op_data in available_operations:
            ...
            # Evaluate machines and times for earliest starting time.
            ...
            # Prioritize based on urgency (remaining work) and balancing machine load.
            priority = (job_remaining_work[job_id] + earliest_start_time )/ (machine_available_times[selected_machine]+1)

...
def heuristic(input_data):
    """
    Heuristic for FJSSP scheduling. Minimizes makespan using Shortest Processing Time (SPT) and earliest machine availability.
    """
    ...
    for job_id, op_num, machines, times in operations:
        ...
        # Find the best machine with shortest processing time and earliest availability

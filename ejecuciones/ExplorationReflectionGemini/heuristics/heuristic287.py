...
def heuristic(input_data):
    """Combines load balancing and job urgency for FJSSP."""
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for operation_index, operation_data in enumerate(job_operations):
            ...
            for machine in possible_machines:
                ...
                # Weighting: balance machine load and job remaining time
                weighted_time = end_time + 0.1 * machine_time[machine] - 0.2 * job_remaining_times[job_id]

...
def heuristic(input_data):
    """Combines SPT, load balancing, and job criticality."""
    ...
    while available_operations:
        ...
        for op_data in available_operations:
            ...
            # Job Criticality: weight by remaining operations.
            remaining_ops = len(jobs[job_id]) - op_idx
            # Combines SPT, load balancing, and job criticality (dynamic weights)
            score = 0.6 * (earliest_start_time + processing_time) + 0.3 * machine_load + 0.1 * remaining_ops

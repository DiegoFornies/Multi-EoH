...
def heuristic(input_data):
    """FJSSP heuristic: SPT & load balancing, considering machine availability."""
    ...
    for job in range(1, n_jobs + 1):
        ...
        for op_idx, operation in enumerate(jobs[job]):
            ...
            for i, machine in enumerate(machines):
                ...
                # Dynamic weight based on operation number
                weight = 0.2 if op_num == 1 else 0.1 # Early operations favor completion time

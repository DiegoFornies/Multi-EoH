...
def heuristic(input_data):
    """Combines SPT, load balancing, and job urgency for scheduling."""
    ...
    while available_operations:
        ...
        for op_data in available_operations:
            ...
            remaining_operations = len(jobs[job_id]) - op_idx
            urgency_factor = remaining_operations / len(jobs[job_id])  # Job urgency

            score = 0.6 * (earliest_start_time + processing_time) + 0.3 * machine_load + 0.1 * (1 - urgency_factor)

...
def heuristic(input_data):
    """Combines earliest availability and dynamic load balancing."""
    ...
    for job in range(1, n_jobs + 1):
        ...
        for op_idx, operation in enumerate(jobs[job]):
            ...
            for i, machine in enumerate(machines):
                ...
                # Dynamic load balance factor
                load_balance_factor = machine_load[machine] / (sum(machine_load.values()) + 1e-6) # Avoid division by zero

                # Combine completion time and load balance

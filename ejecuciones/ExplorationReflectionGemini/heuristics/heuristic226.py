...
def heuristic(input_data):
    """FJSSP heuristic: Combines SPT, load balancing, and dynamic weights."""
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for operation_index, operation_data in enumerate(job_operations):
            ...
            for i, machine in enumerate(possible_machines):
                ...
                load_weight = 0.1  # Default weight
                if machine_load[machine] > sum(machine_load.values()) / n_machines:
                    load_weight = 0.5  # Penalize heavily loaded machines

                # Cost function combining SPT and load balancing.

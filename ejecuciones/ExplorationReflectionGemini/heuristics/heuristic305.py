...
def heuristic(input_data):
    """Dynamic heuristic: Adaptive SPT with lookahead load balancing."""
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for operation_index, operation_data in enumerate(job_operations):
            ...
            for i, machine in enumerate(possible_machines):
                ...
                # Lookahead: Estimate future machine load after the operation
                future_load = machine_load[machine] + processing_time
                #Cost function: Balances processing time with machine load
                cost = processing_time + 0.3 * future_load + 0.01*start_time

...
def heuristic(input_data):
    """Hybrid heuristic: SPT on least loaded machine, considers job completion."""
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for operation_index, operation_data in enumerate(job_operations):
            ...
            for i in range(len(possible_machines)):
                ...
                makespan_machine_load = end_time + 0.01 * machine_load[machine]
                
                if makespan_machine_load < min_makespan:
                    min_makespan = makespan_machine_load

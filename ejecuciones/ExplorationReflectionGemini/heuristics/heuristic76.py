...
def heuristic(input_data):
    ...
    # Step 1: Operation Prioritization (Shortest Processing Time First within Job)
    operation_queue = []
    ...
    for job_id, operation_index in operation_queue:
        ...
        #Machine selection based on makespan & balancing
        ...
        #Update machine load and job completion

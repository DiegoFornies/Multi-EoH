...
def heuristic(input_data):
    """Hybrid heuristic: SPT + machine load balancing for FJSSP."""
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for operation_index, operation_data in enumerate(job_operations):
            ...
            for i, machine in enumerate(possible_machines):
                ...
                # Combined metric: Completion time + machine load + SPT
                combined_metric = end_time + 0.05 * machine_load[machine] + 0.005 * processing_time

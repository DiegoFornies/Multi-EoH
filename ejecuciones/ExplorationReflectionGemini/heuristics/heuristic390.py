...
def heuristic(input_data):
    """Combines SPT, machine load balancing, and earliest start time."""
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for operation_index, operation_data in enumerate(job_operations):
            ...
            for i in range(len(possible_machines)):
                ...
                # Cost: Weighted sum of completion time and machine load
                cost = end_time + 0.05 * machine_load[machine] + 0.01 * processing_time

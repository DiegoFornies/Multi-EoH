...
def heuristic(input_data):
    """
    A heuristic for FJSSP that prioritizes machines with the least workload.
    It aims to minimize makespan and balance machine load by choosing the
    least loaded available machine for each operation.
    """

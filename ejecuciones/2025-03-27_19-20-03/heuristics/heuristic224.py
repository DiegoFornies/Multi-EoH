...
def heuristic(input_data):
    """Schedules jobs minimizing makespan & balancing machine load. Combines priority & load penalty."""
    ...
    # Initial priority: processing time + load
    for job in jobs:
        ops = jobs[job]
    ...
    while priority_list:
        ...
        for m, t in zip(machines, times):
            ...
            load_penalty = machine_load[m] / (sum(machine_load.values()) + 1e-9) #Avoid div by zero

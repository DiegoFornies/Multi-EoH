...
def heuristic(input_data):
    """Combines EDD/SPT and idle time minimization for FJSSP."""
    ...
    for job in job_order:
        ...
        for op_idx, (machines, times) in enumerate(jobs_data[job]):
            ...
            for m_idx, machine in enumerate(machines):
                ...
                elif idle_time == min_idle and processing_time < best_processing_time:
                    best_machine = machine
                    best_processing_time = processing_time

            # Assign if no machine is suitable.

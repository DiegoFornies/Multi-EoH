...
def heuristic(input_data):
    """Combines shortest processing time and earliest due date for scheduling."""
    ...
    for job, operations in jobs_data.items():
        ...
        job_priorities[job] = total_time  # Initial priority: Shortest total time

    job_order = sorted(job_priorities.keys(), key=job_priorities.get)

...
def heuristic(input_data):
    """
    Schedules jobs using a priority rule based on shortest processing time and earliest machine availability.
    Prioritizes jobs with shorter overall processing times and assigns operations to the earliest available machines,
    aiming to reduce overall makespan.
    """

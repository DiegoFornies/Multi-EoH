...
def heuristic(input_data):
    """Heuristic for FJSSP: SPT priority, machine load balancing."""
    ...
    while priority_list:
        ...
        for m_idx, m in enumerate(machines):
            ...
            # Incorporate machine load to break ties
            load_factor = machine_load[m] / (sum(machine_load.values()) + 1e-9) if sum(machine_load.values()) > 0 else 0
            weighted_start_time = start_time + load_factor  # Add a penalty for heavier loaded machines

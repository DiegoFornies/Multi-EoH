...
def heuristic(input_data):
    ...
    # Calculate total processing time for each job initially.
    ...
    while priority_list:
        ...
        if best_machine is None:
            raise ValueError("No suitable machine found")
        ...
        # Recalculate priority based on remaining processing time.

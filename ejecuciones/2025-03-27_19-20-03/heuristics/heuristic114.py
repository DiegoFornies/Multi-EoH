...
def heuristic(input_data):
    """Combines SPT job ordering with earliest machine availability."""
    ...
    # Sort jobs based on SPT.
    job_order = sorted(job_processing_times.keys(), key=job_processing_times.get)

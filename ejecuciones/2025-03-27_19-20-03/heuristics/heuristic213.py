...
def heuristic(input_data):
    """Minimizes makespan, idle time, and balances load."""
    ...
    for job in job_order:
        ...
        for op_idx, (machines, times) in enumerate(jobs_data[job]):
            ...
            for m_idx, machine in enumerate(machines):
                ...
                load_penalty = machine_load[machine] / (sum(machine_load.values()) + 1e-9)
                combined_metric = idle_time + load_penalty + processing_time*0.01

...
def heuristic(input_data):
    ...
    while priority_list:
        ...
        for m, t in zip(machines, times):
            ...
            # Penalize machines with higher load
            load_penalty = machine_load[m]
            effective_start_time = start_time + load_penalty

            if effective_start_time < min_start_time:
                min_start_time = effective_start_time
                best_machine = m
                best_time = t

...
def heuristic(input_data):
    """Hybrid heuristic: priority-based (slack time) with SPT for machine selection."""
    ...
    while priority_list:
        ...
        for m_idx, machine in enumerate(machines):
            start_time = max(machine_time[machine], job_completion_time.get(job, 0)) #completion time of previous operations
        ...
        start_time = max(machine_time[best_machine], job_completion_time.get(job, 0))

...
def heuristic(input_data):
    """Schedules jobs, balancing makespan and machine load. Prioritizes shortest processing time first."""
    ...
    while priority_list:
        ...
        for m, t in zip(machines, times):
            ...
            if start_time < min_start_time or (start_time == min_start_time and t < best_time):

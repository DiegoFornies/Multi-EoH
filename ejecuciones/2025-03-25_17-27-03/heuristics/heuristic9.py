...
def heuristic(input_data):
    ...
    # Create a list of operations with their priorities
    operations = []
    for job, ops in jobs_data.items():
        for op_idx, (machines, times) in enumerate(ops):
            operations.append({
                ...
                'machines': machines,
                'times': times,
                'priority': len(machines)  # Operations with fewer machine choices get higher priority
            })
    
    # Sort operations by priority (fewer machine choices first)
    operations = sorted(operations, key=lambda x: x['priority'])
    ...
    for operation in operations:
        ...
        for m_idx, m in enumerate(machines):
            ...
            if start_time < min_start_time:
                ...
                best_machine = m
                best_time_idx = m_idx #index of selected machine in machines list, needed to get the correct processing time

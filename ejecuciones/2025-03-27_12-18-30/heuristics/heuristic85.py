...
def heuristic(input_data):
    ...
    for job in range(1, n_jobs + 1):
        ...
        job_processing_time[job] = total_processing_time

    job_order = sorted(job_processing_time.items(), key=lambda item: item[1])
    ...
    for job, _ in job_order:
        ...
        for op_idx, (machines, times) in enumerate(jobs[job]):
            ...
            for m_idx, machine in enumerate(machines):
                ...
                load_score = machine_available_time[machine]
                ...
                if start_time < earliest_start_time:
                    ...
                    min_load = load_score
                elif start_time == earliest_start_time and load_score < min_load:
                    best_machine = machine
                    best_processing_time = processing_time
                    min_load = load_score

...
def heuristic(input_data):
    """Schedules jobs by balancing SPT and machine availability."""
    ...
    while operation_queue:
        ...
        for job, op_idx in operation_queue:
            ...
            for i, m in enumerate(machines):
                ...
                if start_time + processing_time < best_start_time_local + best_processing_time_local:
        ...
        for i, m in enumerate(machines):
            ...
            if start_time + processing_time < best_start_time + best_processing_time or best_machine is None:

...
def heuristic(input_data):
    """Schedule jobs, prioritize SPT on lightly loaded machines."""
    ...
    while any(remaining_operations.values()):
        ...
        best_operation = None
        best_machine = None
        best_priority = float('inf') #Lower values for higher priority
        ...
        for job, (op_num, (machines, times)) in eligible_operations:
            for m_idx, m in enumerate(machines):
                ...
                #Priority is Shortest Processing Time + Machine Load
                priority = processing_time + machine_load[m]

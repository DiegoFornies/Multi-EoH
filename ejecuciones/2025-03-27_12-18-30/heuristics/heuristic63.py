...
def heuristic(input_data):
    """Combines SPT and machine availability with adaptive weighting."""
    ...
    while operation_queue:
        ...
        for job, op_idx in operation_queue:
            ...
            # Adaptive weighting: favor shorter processing times more early
            # and machine load later
            weight = 0.6  # Adjust weight dynamically
            weighted_time = weight * (best_start_time_local + best_processing_time_local) + (1-weight) * machine_time[best_machine_local]

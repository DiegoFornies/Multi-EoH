...
def heuristic(input_data):
    """Combines SPT and EDD with dynamic priority."""
    ...
    while any(remaining_operations.values()):
      ...
      for job, (op_num, (machines, times)) in eligible_operations:
          ...
          if chosen_machine is not None:
            ...
            # Incorporate EDD: prioritize jobs closer to due date
            priority = completion_time + (completion_time / job_due_dates[job]) if job_due_dates[job] > 0 else completion_time

...
def heuristic(input_data):
    """Schedules jobs by prioritizing operations with shorter processing times."""
    ...
    # Prepare a list of operations, sorted by processing time
    operations = []
    for job, ops in jobs.items():
        for op_idx, (machines, times) in enumerate(ops):
            operations.append((job, op_idx + 1, machines, times)) # job, op number, machines, times

...
def heuristic(input_data):
    """Schedules jobs, prioritizing shortest processing time and earliest machine availability."""
    ...
    # Prioritize operations based on shortest processing time across all jobs
    operation_queue = []

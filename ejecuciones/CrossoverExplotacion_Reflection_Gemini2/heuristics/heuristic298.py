...
def heuristic(input_data):
    """Combines EFT, SPT, and dynamic machine load for FJSSP."""
    ...
    scheduled_operations = {job: 0 for job in range(1, n_jobs + 1)}

    while operations:
        eligible_operations = []
        for op in operations:
            if op['operation'] == scheduled_operations[op['job']] + 1:
        ...
        if not eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                combined_score = weighted_finish + machine * 0.0001

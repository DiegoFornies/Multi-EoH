...
def heuristic(input_data):
    """Schedules jobs, balancing makespan, machine load and separation."""
        ...
        for job_id, op_index in ready_operations:
            ...
            for machine_id, processing_time in zip(machines, times):
                ...
                if start_time < min_start_time:
                    ...
                    best_machine_candidate = machine_id

            current_separation_potential = job_completion_times[job_id] - min_start_time if job_completion_times[job_id] > 0 else 0 #Calculates how much the job is seperated

            if min_start_time < earliest_start_time or current_separation_potential > separation_potential :
                earliest_start_time = min_start_time
                separation_potential = current_separation_potential

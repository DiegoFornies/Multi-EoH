...
def heuristic(input_data):
    """Hybrid: SPT, workload, job progress. Combines min start time
    & balance machine load. Prioritizes operations with shortest
    processing time considering machine workload."""
    ...
    while operations:
        ...
        if not available_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # Combined metric: end time + weighted workload
        ...
        for operation in available_operations:
            ...
            for m_idx, machine in enumerate(machines):
                ...
                start_time = max(machine_available_time[machine], job_completion_time[job_id])
                end_time = start_time + processing_time_candidate

...
def heuristic(input_data):
    """Schedules jobs balancing makespan and machine workload."""
    ...
    while ready_operations:
        ...
        for machine_id, processing_time in zip(machines, times):
            ...
            combined_metric = completion_time + (workload / total_workload) * 3  # Weighting workload
            combined_metric += processing_time * 0.1 # give a small advantage for shorter processing_time

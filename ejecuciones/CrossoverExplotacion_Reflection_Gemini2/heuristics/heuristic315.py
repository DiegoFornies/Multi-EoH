...
def heuristic(input_data):
    """Schedules FJSSP by combining earliest start and machine load."""
    ...
    for job in range(1, n_jobs + 1):
        ...
        for op_idx, operation in enumerate(jobs[job]):
            ...
            for m_idx, machine in enumerate(machines):
                ...
                # Combine start time and machine load
                score = 0.7 * start_time + 0.3 * machine_load[machine] #Prioritize start time
                if score < min_score:
                    min_score = score

...
def heuristic(input_data):
    """Schedules jobs considering makespan, workload, and separation."""
        ...
        for job_id, op_index in ready_operations:
            ...
            for m_idx, machine_id in enumerate(machines):
                ...
                if job_start_times[job_id]:
                    ...
                    separation_incentive = max(0, (start_time - last_start_time)) * 0.1
                ...
                # Incorporate workload balance into makespan delay
                load_penalty = (machine_workload[machine_id] / (sum(machine_workload.values()) + 1e-6)) * 5 if sum(machine_workload.values()) else 0
                makespan_delay += load_penalty

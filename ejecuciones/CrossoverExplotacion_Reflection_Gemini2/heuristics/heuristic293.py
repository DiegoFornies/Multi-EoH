...
def heuristic(input_data):
    """
    Combines earliest available time, SPT, and dynamic machine
    load balancing for FJSSP scheduling.
    """
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for m_idx, machine_id in enumerate(machines):
                ...
                combined_score = end_time + (workload / (sum(machine_workload.values()) + 1e-6)) * 5 + processing_time

...
def heuristic(input_data):
    """Schedules jobs considering makespan, separation, and balance."""
    ...
    while ready_operations:
        ...
        for machine_id, processing_time in zip(machines, times):
            ...
            # Normalized values to prevent domination
            normalized_workload = machine_workload[machine_id] / max_workload
            normalized_processing_time = processing_time / max_processing_time

            # Combined metric to balance makespan and workload
            combined_metric = completion_time + normalized_workload * 5 # Weighting workload
            
            # Choose the machine with minimum combined metric

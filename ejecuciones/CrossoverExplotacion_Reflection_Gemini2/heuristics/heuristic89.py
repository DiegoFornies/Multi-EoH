...
def heuristic(input_data):
    """Combines SPT and min machine load. Adds operation selection improvement."""
    ...
    #operations.sort(key=lambda op: min(op['times'])) #Sort all operations once
    ...
    while operations:
        ...
        if not eligible_operations:
            #If no operation is ready, find the operation with the shortest processing time from the remaining
            ...
            for i, machine in enumerate(machines):
                ...
                if end_time + workload < min_end_time:
                    min_end_time = end_time + workload
        ...
        # Evaluate eligible operations based on SPT and machine load
        best_operation = None
        best_machine = None

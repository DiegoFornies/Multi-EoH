...
def heuristic(input_data):
    """Schedules jobs considering makespan, workload, and SPT."""
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for m_idx, machine_id in enumerate(machines):
                ...
                # Prioritize shortest processing time and lower machine load
                workload_penalty = machine_workload[machine_id]
                combined_score = end_time + processing_time + workload_penalty

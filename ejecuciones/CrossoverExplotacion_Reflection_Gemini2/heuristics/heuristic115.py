...
def heuristic(input_data):
    """Combines SPT, min workload, and earliest availability."""
    ...
    # Prioritize SPT. sort operations by shortest processing time first
        ...
        if eligible_operations:
            ...
            for operation in eligible_operations:
                ...
                for i, machine in enumerate(machines):
                    ...
                    # Consider both machine load and completion time
            ...
            # Handle blocked jobs by scheduling next operation
            ...
            machine_load[best_machine] = end_time # Update machine load

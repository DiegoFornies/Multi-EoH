...
def heuristic(input_data):
    """Schedules jobs considering EFT, SPT, and machine load."""
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for op_idx, operation in enumerate(jobs_data[job_id]):
            ...
            for i, machine in enumerate(machines):
                ...
                weighted_finish = 0.6 * end_time + 0.4 * processing_time  # EFT and SPT
                load_penalty = 0.02 * machine_available[machine]  # Machine load
                combined_score = weighted_finish + load_penalty

...
def heuristic(input_data):
    """Schedules jobs, balances load using SPT & workload."""
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for m_idx, machine_id in enumerate(machines):
                ...
                workload_penalty = machine_workload[machine_id] * 0.01 
                combined_score = end_time + workload_penalty
        ...
        for i, machine in enumerate(machines):
          ...
          completion_time = start_time + times[i] + machine_workload[machine] * 0.001 #Less penalty

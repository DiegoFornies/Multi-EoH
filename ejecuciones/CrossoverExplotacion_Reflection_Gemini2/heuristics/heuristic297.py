...
def heuristic(input_data):
    """Hybrid heuristic: EFT, SPT, dynamic prioritization based on variance load, and makespan delays."""
    ...
    while operations:
        ...
        if not eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                makespan_delay = (finish_time / (current_makespan + 1e-6)) * 5
                combined_delay = load_penalty + makespan_delay

                weighted_finish = 0.7 * finish_time + 0.3 * machine_load[machine]

                combined_score = weighted_finish + combined_delay + machine * 0.0001

...
def heuristic(input_data):
    """Combines SPT, earliest finish time, and machine load, considers machine id."""
        ...
        for op_idx, operation in enumerate(jobs_data[job_id]):
            ...
            for i, machine in enumerate(machines):
                ...
                if end_time < min_end_time:
                    ...
                    min_machine_id = machine #Considering Machine ID as well
                    ...
                    if processing_time < min_processing_time:
                        ...
                        best_processing_time = processing_time
                        min_machine_load = machine_load
                        min_machine_id = machine
                    elif processing_time == min_processing_time and machine_load < min_machine_load:
                        best_machine = machine
                        best_processing_time = processing_time
                        min_machine_load = machine_load
                        min_machine_id = machine
                    elif processing_time == min_processing_time and machine_load == min_machine_load and machine < min_machine_id:
                        best_machine = machine
                        best_processing_time = processing_time
                        min_machine_id = machine

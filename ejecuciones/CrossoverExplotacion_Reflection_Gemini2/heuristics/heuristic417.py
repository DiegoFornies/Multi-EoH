...
def heuristic(input_data):
    ...
    while ready_operations:
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            weighted_finish = 0.7 * end_time + 0.3 * machine_workload[machine_id]
            combined_delay = load_penalty + makespan_delay

            # Include SPT in combined score
            combined_score = weighted_finish + combined_delay + machine_workload[machine_id] * delay_factor #Incorporating variance

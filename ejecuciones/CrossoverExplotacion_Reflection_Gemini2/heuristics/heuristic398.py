...
def heuristic(input_data):
    ...
    machine_load = {m: 0 for m in range(n_machines)} # load balancing
    schedule = {}
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for op_idx, operation in enumerate(jobs_data[job_id]):
            ...
            for i, machine in enumerate(machines):
                ...
                load_penalty = machine_load[machine] * 0.01 # load balancing
                weighted_end_time = end_time + load_penalty
            ...
            machine_load[best_machine] += best_processing_time # load balancing

...
def heuristic(input_data):
    """Greedy heuristic: Earliest start time with machine load balance."""
    ...
    while operations:
        ...
        for i in range(len(operations)):
            ...
            for j in range(len(machines)):
                ...
                # Prioritize machines with less load (combined score)
                combined_score = machine_load[machine] + end_time
                if combined_score < earliest_start :
                    earliest_start = combined_score
            ...
            if selected_machine is not None:
              if best_start_time > earliest_start:
                ...
                best_start_time = earliest_start-machine_load[selected_machine]

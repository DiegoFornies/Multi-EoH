...
def heuristic(input_data):
    """Combines earliest start time, machine workload, and SPT for FJSSP."""
    ...
    while ready_operations:
        ...
        for machine_id, processing_time in zip(machines, times):
            ...
            # Combine completion time with workload to guide machine selection.
            # Shorter processing time and less loaded machine are prioritized.

...
def heuristic(input_data):
    """Schedules jobs minimizing makespan and balancing workload using a combined approach."""
    ...
    while ready_operations:
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            # Combined workload and availability scores.
            workload_score = machine_workload[machine_id]
            availability_score = end_time

            combined_score = workload_score + availability_score  # Simpler combination

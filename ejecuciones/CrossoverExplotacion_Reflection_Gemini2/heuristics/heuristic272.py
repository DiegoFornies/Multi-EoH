...
def heuristic(input_data):
    """Combines EFT, SPT, load balancing, and job prioritization."""
    ...
    while operations:
        ...
        for operation in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # Combining machine load & job completion time for scoring
                weighted_finish = 0.6 * finish_time + 0.4 * times[i] + 0.1 * machine_load[machine] + 0.05 * job_last_end_time[job_id] + machine * 0.0001

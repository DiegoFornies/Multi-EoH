...
def heuristic(input_data):
    """Combines SPT, earliest finish time, and machine load for FJSSP."""
        ...
        for op_idx, operation in enumerate(jobs_data[job_id]):
            ...
            for i, machine in enumerate(machines):
                ...
                if end_time < min_end_time:
                    ...
                    elif processing_time == min_processing_time and machine_available[machine] < machine_available[best_machine]:
                        best_machine = machine
                        best_processing_time = processing_time
                        min_machine_load = machine_load

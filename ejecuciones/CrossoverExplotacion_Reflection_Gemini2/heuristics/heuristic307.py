...
def heuristic(input_data):
    """Combines EFT, SPT, machine load, and dynamic prioritization."""
    ...
    while operations:
        ...
        if not eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                weighted_finish = 0.6 * finish_time + 0.2 * machine_load[machine] + 0.2 * times[i] #EFT, Machine load, SPT

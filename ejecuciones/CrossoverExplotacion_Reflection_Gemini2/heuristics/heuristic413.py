    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for m_idx, machine_id in enumerate(machines):
                ...
                # Earliest Finish Time + SPT
                weighted_finish = 0.6 * end_time + 0.4 * processing_time

                # Dynamic Load Balancing with variance + makespan aware delay
                ...
                makespan_delay = (end_time / (current_makespan + 1e-6)) * 2

                combined_score = weighted_finish + load_penalty + makespan_delay + machine_workload[machine_id] * delay_factor  + machine_id * 0.0001

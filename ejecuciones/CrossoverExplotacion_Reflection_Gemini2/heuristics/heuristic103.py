...
def heuristic(input_data):
    """Combines earliest finish time and load balancing."""
    ...
    for job_id, operations in jobs.items():
        ...
        for op_idx, operation in enumerate(operations):
            ...
            for i in range(len(machines)):
                ...
                # Consider machine load in addition to finish time
                load_penalty = machine_load[machine] * 0.1  # Adjusted load penalty
                weighted_finish = finish_time + load_penalty

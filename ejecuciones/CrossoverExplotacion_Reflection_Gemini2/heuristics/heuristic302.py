...
def heuristic(input_data):
    """Hybrid heuristic combining earliest finish time and SPT with load balancing."""
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for m_idx, machine_id in enumerate(machines):
                ...
                # SPT component : favors shorter processing times
                weighted_finish = 0.7 * end_time + 0.3 * processing_time

                # Load balancing component, dynamically adjusting to machine loads
                ...
                combined_score = weighted_finish + load_penalty + machine_id * 0.0001 #tie breaker using machine id

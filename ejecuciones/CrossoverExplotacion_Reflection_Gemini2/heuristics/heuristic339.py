...
def heuristic(input_data):
    """Schedules jobs, balancing makespan, separation, and workload."""
    ...
    while ready_operations:
        ...
        # Select machine with shortest makespan AND least workload, prioritize job seperation.
        ...
        #Introduce seperation weight
        seperation_weight = 1.1
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            # Seperation handling, avoid assigning to same machine
            previous_job_end_time = -1
            if schedule[job_id]:
                previous_job_end_time = schedule[job_id][-1]['End Time']
            seperation_delay = 0
            if previous_job_end_time != -1:
                seperation_delay = max(0, end_time - previous_job_end_time) * seperation_weight

            combined_score = end_time + machine_workload[machine_id] * 0.01 + seperation_delay

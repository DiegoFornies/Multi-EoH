...
def heuristic(input_data):
    """Combines workload, makespan, and availability for FJSSP."""
    ...
    while ready_operations:
        ...
        # Select machine considering processing time, workload, and makespan.
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            workload_factor = machine_workload[machine_id] #Workload for machine selection
            makespan_delay = end_time / (current_makespan + 1e-6)

            combined_score = end_time + workload_factor * 0.1 + makespan_delay * 0.05

...
def heuristic(input_data):
    """Heuristic for FJSSP combining SPT and earliest start."""
        ...
        for op_idx, operation in enumerate(jobs_data[job_id]):
            ...
            for i, machine in enumerate(machines):
                ...
                if (start_time < best_start_time) or \
                   (start_time == best_start_time and processing_time < min_end_time): #earliest start tiebreaker
                    best_start_time = start_time #favoring earlier start

...
def heuristic(input_data):
    """Hybrid heuristic: SPT, workload, and job progress."""
    ...
    while operations:
        ...
        if not available_operations:
            # Handle stuck case, find the operation with shortest processing time
            ...
            for i, machine in enumerate(machines):
                ...
                if end_time + 0.001 * workload < min_end_time: #Workload influence
        ...
        # Prioritize operations that can be scheduled now
        best_operation = None
        best_machine = None
        ...
        for operation in available_operations:
            ...
            for m_idx, machine in enumerate(machines):
                ...
                start_time = max(machine_available_time[machine], job_completion_time[job_id])
                end_time = start_time + processing_time
                # Combine machine load, job progress, and SPT.

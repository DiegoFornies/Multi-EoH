...
def heuristic(input_data):
    """Schedules jobs, minimizing makespan and improving separation by delayed assignment."""
    ...
    while ready_operations:
        ...
        # Introduce a delay factor to promote separation
        ...
        for machine_id, processing_time in zip(machines, times):
            ...
            delay_factor = (workload / (sum(machine_workload.values()) + 1e-6)) * (completion_time / (current_makespan + 1e-6)) * 5 # increased scaling
            
            # Combined metric: completion time + workload + delay

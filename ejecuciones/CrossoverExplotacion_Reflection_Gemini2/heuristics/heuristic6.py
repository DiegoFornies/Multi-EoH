...
def heuristic(input_data):
    ...
    It iterates through jobs and operations, assigning operations to machines
    based on earliest available finish time, considering both machine and job availability.
    """

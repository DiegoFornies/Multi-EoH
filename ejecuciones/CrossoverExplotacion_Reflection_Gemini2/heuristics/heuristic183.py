...
def heuristic(input_data):
    """Combines Earliest Finish Time (EFT) with machine load balancing."""
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for machine_id, processing_time in zip(machines, times):
                ...
                # Prioritize machines with less workload
                weighted_completion = completion_time + machine_load[machine_id] * 0.01  

                if weighted_completion < earliest_completion_time:

    ...
    while operations:
        ...
        if not available_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                if end_time + 0.001 * workload < min_end_time:
                    min_end_time = end_time = start_time + times[i] #Fixed workload and endtime
        ...
        for operation in available_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                weighted_completion = 0.7 * completion_time + 0.3 * load_penalty
                remaining_ops = len([op for op in operations if op['job'] == job_id]) - 1
                tie_break_value = weighted_completion + remaining_ops * 0.01 + machine * 0.0001  # Fix tie breaker.

...
def heuristic(input_data):
    ...
    while ready_operations:
        ...
        # Select machine balancing workload and makespan
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            # Prioritize less loaded machines, add a makespan component
            ...
            combined_score = end_time + load_penalty + makespan_delay

...
def heuristic(input_data):
    ...
    while ready_operations:
        ...
        # Select machine considering both workload and makespan.
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            makespan_delay = (end_time / (current_makespan + 1e-6)) * 1

            combined_score = end_time + normalized_workload * 3 + makespan_delay # Weighting workload

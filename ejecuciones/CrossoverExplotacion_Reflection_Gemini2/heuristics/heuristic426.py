...
def heuristic(input_data):
    """FJSSP heuristic: Combines SPT, machine load, and job sequencing."""
    ...
    for job_id, operations in jobs.items():
        ...
        for op_idx, operation in enumerate(operations):
            ...
            for i in range(len(machines)):
                ...
                # Hybrid score considering makespan, machine load, and SPT
                combined_score = 0.3 * end_time + 0.4 * machine_load[machine] + 0.3 * time

    ...
    while operations:
        ...
        if not eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                normalized_workload = machine_load[machine] / (sum(machine_load.values()) + 1e-6) if sum(machine_load.values()) > 0 else 0
                combined_score = finish_time + 5 * normalized_workload + delay_factor*machine # SPT and workload balance

...
def heuristic(input_data):
    """Schedules jobs balancing workload and minimizing makespan using combined rules."""
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for m_idx, machine_id in enumerate(machines):
                ...
                # Combined score: SPT, machine load, job completion
                score = 0.4 * processing_time + 0.3 * machine_workload[machine_id] + 0.3 * end_time

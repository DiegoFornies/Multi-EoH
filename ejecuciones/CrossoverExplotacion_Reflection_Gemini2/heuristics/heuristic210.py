...
def heuristic(input_data):
    """Combines workload, makespan, and SPT for FJSSP."""
    ...
    while ready_operations:
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            makespan_score = end_time # Directly use end_time as makespan proxy
            
            combined_score = workload_score + makespan_score

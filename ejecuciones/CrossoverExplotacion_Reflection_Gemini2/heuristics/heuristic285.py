...
def heuristic(input_data):
    """Combines workload balancing and SPT for FJSSP."""
    ...
    while operations:
        ...
        if not eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # SPT + workload consideration
                workload_factor = machine_load[machine] / (sum(machine_load.values()) + 1e-6)
                combined_score = 0.7 * finish_time + 0.3 * workload_factor * finish_time  + machine*0.0001 # SPT + Workload balance

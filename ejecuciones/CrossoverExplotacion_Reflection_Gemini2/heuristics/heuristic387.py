...
def heuristic(input_data):
    """Schedules jobs, balancing earliest finish and shortest processing time."""
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for op_idx, operation in enumerate(jobs_data[job_id]):
            ...
            for i, machine in enumerate(machines):
                ...
                #primary criteria: earliest end time
                if end_time < min_end_time:
                    min_end_time = end_time
                    best_machine = machine
                    best_processing_time = processing_time
                # secondary criteria: shortest processing time
                elif end_time == min_end_time and processing_time < best_processing_time:
                    best_machine = machine
                    best_processing_time = processing_time

...
def heuristic(input_data):
    """Schedules FJSSP using a weighted earliest finish time and machine load."""
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for m_idx, machine_id in enumerate(machines):
                ...
                # Combine finish time, SPT, and machine load.
                weighted_finish = 0.6 * end_time + 0.4 * processing_time
                load_penalty = 0.01 * machine_workload[machine_id]

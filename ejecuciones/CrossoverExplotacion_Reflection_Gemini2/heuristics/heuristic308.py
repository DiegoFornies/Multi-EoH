...
def heuristic(input_data):
    """Combines earliest start time and machine workload for FJSSP."""
    ...
    while ready_operations:
        ...
        # Select machine with workload consideration & finish time.
        ...
        for machine_id, processing_time in zip(machines, times):
            ...
            # Weight finish time and machine load.
            weighted_finish = 0.7 * finish_time + 0.3 * machine_workload[machine_id]
            
            if weighted_finish < earliest_finish_time:
                earliest_finish_time = weighted_finish

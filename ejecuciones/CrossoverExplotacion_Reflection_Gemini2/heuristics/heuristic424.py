...
def heuristic(input_data):
    """Combines EFT, SPT, and machine load for FJSSP."""
    ...
    while operations:
        ...
        if not eligible_operations:
            ...
            eligible_operations = [shortest_operation]  # Force scheduling
        ...
        for operation in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                weighted_finish = 0.6 * finish_time + 0.4 * machine_load[machine]  # SPT+machine load
                combined_score = weighted_finish + machine*0.0001  #Tie breaker

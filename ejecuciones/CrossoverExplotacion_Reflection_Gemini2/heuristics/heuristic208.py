...
def heuristic(input_data):
    """Schedules jobs balancing load & minimizing makespan."""
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for m_idx, machine_id in enumerate(machines):
                ...
                # Combine workload and makespan criteria
                workload_factor = machine_workload[machine_id]
                makespan_factor = end_time
                combined_score = workload_factor + makespan_factor

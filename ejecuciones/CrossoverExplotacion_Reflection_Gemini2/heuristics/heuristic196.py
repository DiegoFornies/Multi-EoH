    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for machine_id, processing_time in zip(machines, times):
                ...
                load_penalty = machine_load[machine_id] * 0.001
                completion_time_with_penalty = finish_time + load_penalty

                if completion_time_with_penalty < earliest_finish:
                    earliest_finish = completion_time_with_penalty

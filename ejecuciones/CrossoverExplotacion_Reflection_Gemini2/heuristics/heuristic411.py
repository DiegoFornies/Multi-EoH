...
def heuristic(input_data):
    """
    Schedules jobs, balances load, minimizes makespan using workload & availability.
    """
    ...
    while ready_operations:
        ...
        # Select machine using combined workload & availability score.
        best_machine, best_processing_time, best_start_time = None, float('inf'), float('inf')
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            #Workload + end time. The lower, the better
            combined_score = machine_workload[machine_id] + end_time

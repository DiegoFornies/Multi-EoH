...
def heuristic(input_data):
    """Hybrid heuristic minimizing makespan and balancing load."""
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for m_idx, machine_id in enumerate(machines):
                ...
                # Combine earliest finish time, shortest processing time, machine workload.
                workload_factor = machine_workload[machine_id] * 0.01 #Scale impact
                combined_score = end_time + workload_factor

...
def heuristic(input_data):
    ...
    while ready_operations:
        ...
        # Select machine with workload and SPT consideration
        ...
        for i, machine_id in enumerate(machines):
            ...
            machine_load = machine_available_times[machine_id]

            if end_time < earliest_completion_time:
                earliest_completion_time = end_time
                best_machine = machine_id
                best_processing_time = processing_time
                min_processing_time = processing_time
                min_machine_load = machine_load

            elif end_time == earliest_completion_time:

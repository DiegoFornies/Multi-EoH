...
def heuristic(input_data):
    """
    Combines workload & availability, prioritizing machines with the least combined score.
    Dynamically balances machine load during operation assignment.
    """
    ...
    while ready_operations:
        ...
        for machine_id, processing_time in zip(machines, times):
            ...
            combined_score = machine_workload[machine_id] + completion_time

            if combined_score < earliest_completion_time:
                earliest_completion_time = combined_score

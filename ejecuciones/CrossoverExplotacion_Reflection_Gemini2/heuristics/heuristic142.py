...
def heuristic(input_data):
    """
    Hybrid heuristic: SPT on least loaded machine, minimizing
    makespan and balancing load using machine workload.
    """
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for machine_id, processing_time in zip(machines, times):
                ...
                combined_metric = completion_time + (workload / (sum(machine_workload.values()) + 1e-6)) * 5 # Scaling workload

...
def heuristic(input_data):
    """Schedules jobs considering machine load, completion time, and SPT."""
    ...
    while operations:
        ...
        if not eligible_operations:
            # Handle operations that are not yet feasible (due to precedence)
            ...
            for i, machine in enumerate(machines):
                ...
                combined_score = machine_load[machine] + finish_time

...
def heuristic(input_data):
    """Combines EFT, dynamic prioritization, and SPT for FJSSP."""
    ...
    while operations:
        ...
        if not eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                weighted_finish = 0.7 * finish_time + 0.3 * machine_load[machine] #SPT
                load_penalty = normalized_workload * delay_factor

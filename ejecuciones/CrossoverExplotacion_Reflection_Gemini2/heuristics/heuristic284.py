...
def heuristic(input_data):
    ...
    for job_id, operations in jobs.items():
        ...
        for op_idx, operation in enumerate(operations):
            ...
            # Normalize machine load
            max_load = max(machine_load.values()) + 1e-6  # Avoid division by zero
            ...
            for i in range(len(machines)):
                ...
                normalized_load = machine_load[machine] / max_load
                weighted_finish = finish_time + 0.5 * normalized_load #Consider makespan and balance

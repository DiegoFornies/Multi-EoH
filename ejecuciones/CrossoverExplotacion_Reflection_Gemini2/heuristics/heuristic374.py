...
def heuristic(input_data):
    """
    Hybrid heuristic: Combines workload & earliest time, prioritizes ready ops.
    Minimizes makespan, balances load with adaptive weighting.
    """
    ...
    while ready_operations:
        ...
        total_workload = sum(machine_workload.values()) + 1e-6  # Avoid division by zero
        ...
        for m_idx, machine in enumerate(machines):
            ...
            workload_factor = (machine_workload[machine] / total_workload) * 5 # Scaled

            combined_score = end_time + workload_factor # Adaptive combined score

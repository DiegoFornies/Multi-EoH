...
def heuristic(input_data):
    ...
    while ready_operations:
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            #Combined both workload and makespan aware delays and earliest start time
            ...
            earliest_delay = start_time

            combined_delay = load_penalty + makespan_delay + earliest_delay

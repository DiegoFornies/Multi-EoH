...
def heuristic(input_data):
    """Combines earliest finish time, machine load, and job sequencing for FJSSP."""
    ...
    while ready_operations:
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            combined_score = 0.4 * end_time + 0.4 * machine_workload[machine_id] + 0.2 * processing_time

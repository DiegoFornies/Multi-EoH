...
def heuristic(input_data):
    """Schedules jobs considering earliest finish time, SPT, and machine workload."""
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for op_idx, operation in enumerate(jobs_data[job_id]):
            ...
            for i, machine in enumerate(machines):
                ...
                combined_metric = end_time + (workload / (sum(machine_workload.values()) + 1e-6)) * 5
                ...
                elif combined_metric == min_combined_metric and processing_time < best_processing_time:
                    best_machine = machine
                    best_processing_time = processing_time

...
def heuristic(input_data):
    """Combines min workload, earliest avail time, and shortest processing time."""
        ...
        if eligible_operations:
            ...
            for operation in eligible_operations:
                ...
                for i, machine in enumerate(machines):
                    ...
                    combined_score = machine_load[machine] + end_time + processing_time # Lower is better
            ...
            for i, machine in enumerate(machines):
                ...
                if end_time + machine_load[machine] < min_end_time:

...
def heuristic(input_data):
    ...
    while ready_operations:
        ...
        # Workload normalization and combined metric.
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            makespan_delay = (end_time / (current_makespan + 1e-6)) * 2  #Makespan impact

            combined_score = end_time + normalized_workload * 3 + makespan_delay #Combine all score factors

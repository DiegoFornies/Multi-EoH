...
def heuristic(input_data):
    """Hybrid EFT, SPT, load balancing heuristic for FJSSP."""
    ...
    while operations:
        ...
        if not eligible_operations:
            ...
            eligible_operations = [shortest_operation]
        ...
        for operation in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                load_penalty = (machine_workload[machine] / (sum(machine_workload.values()) + 1e-6)) * 5
                makespan_delay = (end_time / (current_makespan + 1e-6)) * 5
                combined_delay = load_penalty + makespan_delay
                
                combined_score = end_time + combined_delay + machine_workload[machine] * delay_factor

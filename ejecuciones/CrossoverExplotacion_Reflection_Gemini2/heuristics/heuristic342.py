...
def heuristic(input_data):
    """Combines EFT, SPT, and load balancing for FJSSP."""
    ...
    while operations:
        ...
        for operation in available_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                load_penalty = machine_load[machine] * 0.001  #Adjusted load balance impact
                weighted_completion = 0.7 * completion_time + 0.3 * load_penalty

                if weighted_completion < min_completion_time or (weighted_completion == min_completion_time and times[i] < tie_breaker): #Tiebreaker on processing time.

...
def heuristic(input_data):
    """Combines earliest start time, SPT, and machine workload balancing."""
    ...
    while ready_operations:
        ...
        for machine_id, processing_time in zip(machines, times):
            ...
            # Prioritize less loaded machines with smaller completion times AND SPT
            combined_metric = completion_time + (workload / (sum(machine_workload.values()) + 1e-6)) * 5 + processing_time

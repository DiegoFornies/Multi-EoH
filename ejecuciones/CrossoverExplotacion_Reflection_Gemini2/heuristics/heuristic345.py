...
def heuristic(input_data):
    ...
    while ready_operations:
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            makespan_delay = (end_time/ (max(machine_available_times.values()) + 1e-6)) if machine_available_times else 0
            combined_score = machine_workload[machine_id] + end_time + makespan_delay

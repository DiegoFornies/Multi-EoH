...
def heuristic(input_data):
    """
    Schedules operations considering both makespan and machine load.
    """
    ...
    machine_load = {m: 0 for m in range(n_machines)} # Track total load
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for machine_id, processing_time in zip(machines, times):
                ...
                # Weighted cost: makespan + load balance
                makespan_cost = completion_time
                load_cost = machine_load[machine_id]

                #Tune weights for makespan and load balance
                makespan_weight = 0.7
                load_weight = 0.3

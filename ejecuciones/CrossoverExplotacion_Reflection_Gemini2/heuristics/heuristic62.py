...
def heuristic(input_data):
    """Hybrid heuristic: shortest processing time, earliest finish time, sequence feasibility."""
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for op_idx, operation in enumerate(jobs_data[job_id]):
            ...
            for i, machine in enumerate(machines):
                ...
                if processing_time < min_end_time:
                    min_end_time = processing_time # Prioritize shortest processing time

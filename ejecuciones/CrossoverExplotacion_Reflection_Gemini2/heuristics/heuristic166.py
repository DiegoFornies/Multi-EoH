...
def heuristic(input_data):
    """Schedules jobs considering machine workload and job dependencies."""
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for machine_id, processing_time in zip(machines, times):
                ...
                # Weighted finish time to balance makespan and machine load
                weighted_finish = 0.6 * finish_time + 0.4 * machine_load[machine_id]

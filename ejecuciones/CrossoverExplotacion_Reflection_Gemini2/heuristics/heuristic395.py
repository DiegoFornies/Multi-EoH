...
def heuristic(input_data):
    """Schedules jobs considering makespan, separation, and balance using a combined normalized metric."""
    ...
    while ready_operations:
        ...
        # Select machine with workload consideration and normalization
        ...
        for machine_id, processing_time in zip(machines, times):
            ...
            combined_metric = completion_time + normalized_workload * 5 # weighted normalization to balance

...
def heuristic(input_data):
    """Combines earliest start time, SPT, and load balancing."""
    ...
    while ready_operations:
        ...
        max_processing_time = max(times) + 1e-6  # Avoid division by zero
        ...
        for machine_id, processing_time in zip(machines, times):
            ...
            # Combined metric considering workload, processing time and completion time
            ...
            combined_metric = completion_time + normalized_workload * 3 + normalized_processing_time * 2

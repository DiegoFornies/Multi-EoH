...
def heuristic(input_data):
    """Schedules jobs using earliest finish time, SPT, and workload balancing."""
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for m_idx, machine_id in enumerate(machines):
                ...
                combined_score = end_time + workload_score + processing_time #Earliest finish time+workload+SPT

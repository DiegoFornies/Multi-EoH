...
def heuristic(input_data):
    """FJSSP heuristic: Combines SPT, EFT, and machine load. """
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for op_idx, operation in enumerate(jobs_data[job_id]):
            ...
            for i, machine in enumerate(machines):
                ...
                # Weighted combination of EFT, SPT, and machine load
                eft_weight = 0.6
                spt_weight = 0.3
                load_weight = 0.1

                eft_score = eft_weight * end_time
                spt_score = spt_weight * processing_time
                load_score = load_weight * machine_available[machine]

                combined_score = eft_score + spt_score + load_score

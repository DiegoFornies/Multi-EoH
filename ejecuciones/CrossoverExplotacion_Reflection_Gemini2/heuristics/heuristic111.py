...
def heuristic(input_data):
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            best_machine_local, best_processing_time_local = None, float('inf')
            earliest_completion_time_local = float('inf')
            ...
            for machine_id, processing_time in zip(machines, times):
                ...
                if completion_time < earliest_completion_time_local:
                    earliest_completion_time_local = completion_time
                    best_machine_local, best_processing_time_local = machine_id, processing_time
                    
            if earliest_completion_time_local < min_completion_time:
                min_completion_time = earliest_completion_time_local
                best_job, best_op_index = job_id, op_index
                best_machine, best_processing_time = best_machine_local, best_processing_time_local

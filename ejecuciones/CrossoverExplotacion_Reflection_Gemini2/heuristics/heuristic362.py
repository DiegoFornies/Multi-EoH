...
def heuristic(input_data):
    ...
    while ready_operations:
        ...
        max_processing_time = max(times) + 1e-6  # Avoid zero division
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            # Weighted combination of completion time and workload
            combined_score = end_time + normalized_workload * 3  # Weighting workload

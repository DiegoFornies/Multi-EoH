    ...
    while operations:
        ...
        for operation in available_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                if (start_time + load_penalty < best_start_time) or (start_time + load_penalty == best_start_time and times[i] < processing_time) or (weighted_completion < min_completion_time or (weighted_completion == min_completion_time and tie_break_value < tie_breaker)):

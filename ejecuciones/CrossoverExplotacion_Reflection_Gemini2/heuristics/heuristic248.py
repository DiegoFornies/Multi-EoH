...
def heuristic(input_data):
    """FJSSP heuristic: Combines SPT, earliest start, and machine load balancing."""
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for op_idx, operation in enumerate(jobs_data[job_id]):
            ...
            for i, machine in enumerate(machines):
                ...
                load_penalty = machine_load[machine] * 0.001  # small penalty for machine load
                combined_metric = end_time + load_penalty  # combined metric for machine selection

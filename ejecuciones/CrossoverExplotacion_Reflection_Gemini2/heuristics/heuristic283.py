...
def heuristic(input_data):
    """Schedules jobs minimizing makespan, balances machine load."""
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for machine_id, processing_time in zip(machines, times):
                ...
                # Combine makespan & load balance with scaling
                workload_factor = (machine_workload[machine_id] / (sum(machine_workload.values()) + 1e-6)) * 0.5

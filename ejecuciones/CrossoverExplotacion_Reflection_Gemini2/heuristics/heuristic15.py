...
def heuristic(input_data):
    ...
    # Assign operations based on earliest available machine and shortest processing time
    for job_id, operations in jobs.items():
        ...
        for op_idx, operation in enumerate(operations):
            ...
            # Find the best machine with the shortest processing time and earliest available time

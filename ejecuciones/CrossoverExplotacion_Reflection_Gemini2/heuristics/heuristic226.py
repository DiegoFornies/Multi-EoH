...
def heuristic(input_data):
    """Combines earliest finish time, machine load, and operation prioritization."""
    ...
    while operations:
        ...
        if not eligible_operations:
            # Prioritize operations with shortest processing time if no eligible operations.
            ...
            for i, machine in enumerate(machines):
                ...
                combined_score = end_time + machine_load[machine] 

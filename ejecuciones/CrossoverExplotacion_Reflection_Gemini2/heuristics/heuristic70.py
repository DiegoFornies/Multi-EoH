...
def heuristic(input_data):
    """Combines SPT on least loaded machine with dynamic delay."""
    ...
    while ready_operations:
        ...
        # Dynamic delay factor based on average machine load
        avg_load = sum(machine_load.values()) / n_machines if n_machines > 0 else 0
        delay_factor = 0.01 + (avg_load / 1000.0)  # Adjust scaling

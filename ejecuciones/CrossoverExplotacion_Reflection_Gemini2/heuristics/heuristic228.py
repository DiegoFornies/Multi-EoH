...
def heuristic(input_data):
    """Combines SPT, machine load, and job dependencies for better scheduling."""
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            if min_start_time < earliest_finish:
                earliest_finish = min_start_time
        ...
        for machine_id, processing_time in zip(machines, times):
            ...
            normalized_workload = machine_load[machine_id] / max_workload
            normalized_processing_time = processing_time / max_processing_time

            combined_metric = completion_time + normalized_workload * 3 

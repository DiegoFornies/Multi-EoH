...
def heuristic(input_data):
    """
    Combines min workload and earliest avail time, prioritizing operations ready for scheduling.
    """
        ...
        if eligible_operations:
            ...
            for operation in eligible_operations:
                ...
                for i, machine in enumerate(machines):
                    ...
                    combined_score = machine_load[machine] + end_time # Lower is better

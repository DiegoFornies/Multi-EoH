...
def heuristic(input_data):
    """Combines EFT, SPT, machine load, and job completion for FJSSP."""
    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for op_idx, operation in enumerate(jobs_data[job_id]):
            ...
            for i, machine in enumerate(machines):
                ...
                # Combine EFT, SPT, and machine load, job completion time
                weighted_finish = 0.6 * end_time + 0.2 * processing_time + 0.2 * job_completion[job_id]  # EFT and SPT and previous job completion

...
def heuristic(input_data):
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            remaining_ops = len(jobs_data[job_id]) - op_index

            # Check possible earliest finish time
        ...
        # Use a heuristic combining EFT, workload, and job criticality
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            # Prioritize jobs with more operations remaining
            remaining_ops = len(jobs_data[job_id]) - op_index
            remaining_jobs_penalty = (n_jobs - job_id) * 0.1

            combined_score = end_time + combined_delay + machine_workload[machine_id] * delay_factor + remaining_jobs_penalty #Incorporating variance

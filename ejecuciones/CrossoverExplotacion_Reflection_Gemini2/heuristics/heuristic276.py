    ...
    for job_id in range(1, n_jobs + 1):
        ...
        for op_idx, operation in enumerate(jobs[job_id]):
            ...
            for i, machine in enumerate(machines):
                ...
                # Prioritize earliest start, then machine load
                load_penalty = machine_load[machine] * 0.001
                weighted_start_time = start_time + load_penalty

                if weighted_start_time < best_start_time or (weighted_start_time == best_start_time and processing_time < best_processing_time):
                    best_start_time = weighted_start_time

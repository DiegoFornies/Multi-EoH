...
def heuristic(input_data):
    """FJSSP heuristic: SPT, earliest start, machine load, job remaining op."""
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                tie_break_value = end_time + remaining_ops * 0.01

                if end_time < min_end_time or (end_time == min_end_time and tie_break_value < tie_breaker):

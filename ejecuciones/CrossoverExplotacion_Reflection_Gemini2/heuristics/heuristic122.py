    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for machine_id, processing_time in zip(machines, times):
                ...
                makespan_cost = end_time
                load_cost = machine_load[machine_id]

                makespan_weight = 0.6 # Tune makespan influence
                load_weight = 0.4  # Tune load balance influence
                weighted_cost = makespan_weight * makespan_cost + load_weight * load_cost
                ...
                elif weighted_cost == min_weighted_cost and processing_time < best_processing_time if best_processing_time is not None else True:
                    best_job, best_op_index = job_id, op_index
                    best_machine = machine_id
                    best_processing_time = processing_time

...
def heuristic(input_data):
    """Combines SPT and least loaded machine, considering job dependencies."""
    ...
    while ready_operations:
        ...
        for job_id, op_index in ready_operations:
            ...
            for machine_id, processing_time in zip(machines, times):
                ...
                #Weighted finish time with workload factor
                weighted_finish = finish_time + (workload / (sum(machine_load.values()) + 1e-6)) * 2 #Adjusted factor

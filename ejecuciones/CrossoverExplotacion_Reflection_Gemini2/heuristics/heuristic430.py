...
def heuristic(input_data):
    """Schedules jobs considering machine workload and job completion."""
    ...
    while ready_operations:
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            normalized_workload = workload / (total_workload + 1e-6) if total_workload > 0 else 0

            # Combine completion time and normalized workload
            combined_metric = completion_time + normalized_workload * 5 # added workload scaling

...
def heuristic(input_data):
    """Schedules jobs considering makespan and machine workload."""
    ...
    while ready_operations:
        ...
        for m_idx, machine_id in enumerate(machines):
            ...
            # Workload aware completion time.
            workload = machine_workload[machine_id]
            load_penalty = (workload / (sum(machine_workload.values()) + 1e-6)) * 5
            makespan_delay = (completion_time / (current_makespan + 1e-6)) * 1
            combined_metric = completion_time + load_penalty + makespan_delay

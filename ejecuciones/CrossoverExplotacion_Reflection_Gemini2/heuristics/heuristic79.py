...
def heuristic(input_data):
    ...
    by considering machine workload in operation assignment.
    """
    ...
    while ready_operations:
        ...
        for machine_id, processing_time in zip(machines, times):
            ...
            combined_metric = completion_time + (workload / (sum(machine_workload.values()) + 1e-6)) * 5 # added workload and scaling

...
def heuristic(input_data):
    """Combines earliest start, SPT, and machine load for FJSSP."""
    ...
    for job in range(1, n_jobs + 1):
        ...
        for op_idx, operation in enumerate(jobs[job]):
            ...
            for m_idx, machine in enumerate(machines):
                ...
                # Combined score: earliest start + SPT + workload
                combined_score = start_time + processing_time + workload_factor

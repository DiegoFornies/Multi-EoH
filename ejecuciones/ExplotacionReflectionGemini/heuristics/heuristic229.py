...
def heuristic(input_data):
    """Combines greedy makespan and local search to minimize makespan and balance machine load."""
    ...
    while available_operations:
        best_operation = None
        best_machine = None
        earliest_end_time = float('inf')  # Changed to earliest end time
        ...
        for job_id, op_idx in available_operations:
            ...
            for machine_idx, machine in enumerate(machines):
                ...
                if end_time < earliest_end_time: #Compare using end time
    ...
    # Phase 2: Balance Improvement (Local Search - Reassignment)

...
def heuristic(input_data):
    """A heuristic for FJSSP using Shortest Processing Time (SPT) 
    and machine load balancing to minimize makespan and balance load."""
    ...
    while available_operations:
        ...
        for job_id, op_idx in available_operations:
            ...
            for machine_idx, machine in enumerate(machines):
                ...
                # Consider machine load for balancing

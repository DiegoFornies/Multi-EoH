...
def heuristic(input_data):
    """Combines greedy scheduling, SPT, and load balancing."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i in range(len(machines)):
                ...
                if end_time < best_completion_time:
                    best_completion_time = end_time
                    best_start_time = start_time
                    best_time = time
                    best_machine = machine
                    best_load = machine_load[machine]
                elif end_time == best_completion_time:
            ...
            if best_completion_time < min_completion_time:
                min_completion_time = best_completion_time

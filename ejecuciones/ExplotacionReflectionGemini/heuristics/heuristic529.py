...
def heuristic(input_data):
    """Schedules FJSSP using a combination of shortest processing time and machine load balancing."""
    ...
    while len(scheduled_operations) < sum(len(ops) for ops in jobs.values()):
        ...
        for job_id, op_idx, op_data in operations:
            ...
            for m_idx, machine in enumerate(machines):
                ...
                score = start_time + machine_load[machine] # minimize idle time + machine load

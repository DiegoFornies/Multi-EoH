...
def heuristic(input_data):
    """FJSSP heuristic: Combines idle time, remaining operations, machine load."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # Score: prioritize less remaining ops, lower idle time, balance machine load.
                score = remaining + start_time + 0.3 * machine_load[machine]

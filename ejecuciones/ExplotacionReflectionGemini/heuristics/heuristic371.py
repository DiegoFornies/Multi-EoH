...
def heuristic(input_data):
    """Schedules jobs considering idle time, machine load, and remaining operations."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # Combines remaining ops, idle time, & machine load. Adjusted weights.
                score = start_time + (machine_load[machine] * 0.2) + (remaining * 0.3)

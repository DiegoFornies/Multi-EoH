...
def heuristic(input_data):
    """FJSSP heuristic combines greedy, SPT, and local search."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # Score considers remaining ops, idle time, & machine load, SPT
                score = start_time + machine_load[machine] * 0.1 + processing_time*0.1
    ...
    # Local search for balancing machine load

...
def heuristic(input_data):
    """Hybrid heuristic: Greedy makespan, then local search (swap & reassignment) for balance."""
    ...
    # Phase 2: Balance Improvement (Local Search - Combined Swap & Reassignment)
    ...
    #Improvement by swap and reassignment
    for job_id in range(1,n_jobs+1):
        # Swap operations improvement

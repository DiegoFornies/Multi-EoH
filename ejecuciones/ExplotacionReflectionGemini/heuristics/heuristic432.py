...
def heuristic(input_data):
    """FJSSP heuristic: Minimizes idle time, prioritizes jobs with fewer remaining ops."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                #Heuristic that minimizes start time and also consider remaining operations
                score = start_time + 0.5 * remaining  

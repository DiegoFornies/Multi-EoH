...
def heuristic(input_data):
    """A combined heuristic for FJSSP."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                score = remaining + start_time  # weighted idle time and remaining tasks.
                # Prioritize shorter processing times
                score += processing_time * 0.1
                if score < min_score:
                    min_score = score

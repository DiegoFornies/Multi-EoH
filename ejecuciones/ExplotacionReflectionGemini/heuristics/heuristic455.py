...
def heuristic(input_data):
    """Combines earliest avail. machine, machine load."""
    ...
    while eligible_operations:
        ...
        for job, op_idx in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                score = start_time + machine_available_time[machine]
                if score < min_score:
                    min_score = score
                    best_operation = (job, op_idx, job, machine, start_time, processing_time)

        if best_operation:
            op_idx, job, machine, start_time, processing_time = best_operation
            end_time = start_time + processing_time

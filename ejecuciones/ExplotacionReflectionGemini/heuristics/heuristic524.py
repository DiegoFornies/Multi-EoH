...
def heuristic(input_data):
    """FJSSP heuristic: Minimizes machine idle time, prioritizes jobs with fewer remaining operations."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                score = (remaining * 0.5) + start_time # minimize idle time and jobs with fewer remaining tasks.

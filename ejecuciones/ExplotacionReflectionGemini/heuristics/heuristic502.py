...
def heuristic(input_data):
    """Schedules jobs by balancing machine load and minimizing start time."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i in range(len(machines)):
                ...
                #score = remaining + end_time + machine_load_score #Minimize remaining operations, end time, and machine load.
                score = start_time + remaining + machine_load_score # prioritize start time

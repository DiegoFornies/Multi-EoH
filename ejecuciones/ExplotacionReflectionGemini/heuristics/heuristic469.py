    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i in range(len(machines)):
                ...
                # Prioritize shortest processing time, balance machine load,
                # reduce idle time and consider remaining operations.
                score = time + 0.5 * start_time + 0.2 * machine_load_factor + 0.1 * remaining

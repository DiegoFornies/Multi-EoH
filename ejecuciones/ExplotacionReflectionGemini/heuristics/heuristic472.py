...
def heuristic(input_data):
    """Combines SPT, machine load, and reassignment for FJSSP."""
        ...
        for op_idx in range(len(schedule[job_id])):
            ...
            for new_machine in machines:
                if new_machine != original_machine:
                    ...
                    temp_job_last_end_time = {j: 0 for j in range(1, n_jobs + 1)}
                    ...
                    for job_id_re in range(1, n_jobs + 1):
                        for op_idx_re in range(len(jobs_data[job_id_re])):
                            ...
                            start_time = max(temp_machine_available_time[machine], temp_job_last_end_time[job_id_re])
                            ...
                            temp_job_last_end_time[job_id_re] = end_time
                    ...
                    if new_objectives['Balance'] < best_objectives['Balance']:
                        ...
                        machine_available_time = temp_machine_available_time
                        job_last_end_time = temp_job_last_end_time

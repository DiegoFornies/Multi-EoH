...
def heuristic(input_data):
    """Greedy heuristic for FJSSP combining makespan, load balancing, and operation order."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # Score: Minimize start time, balance machine load, prioritize remaining operations.
                score = start_time + machine_load[machine] * 0.2 + remaining * 0.1 + op_idx * 0.05 #weight operation order

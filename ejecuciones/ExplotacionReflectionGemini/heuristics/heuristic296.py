...
def heuristic(input_data):
    """Combines greedy makespan with iterative machine reassignment."""
    ...
    # Phase 2: Balance Improvement (Iterative Reassignment)
    ...
    # Reassignment iterations with a defined limit
    num_iterations = 10  # Limiting iterations
                ...
                for new_machine in machines:
                    if new_machine != original_machine:
                        ...
                        for j in range(1, n_jobs+1):
                            temp_schedule[j] = [op.copy() for op in schedule[j]] # Deep copy
                        ...
                        is_feasible = True # Check for feasibility

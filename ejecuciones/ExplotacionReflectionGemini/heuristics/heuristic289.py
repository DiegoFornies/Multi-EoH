...
def heuristic(input_data):
    """Combines SPT, load balancing, and remaining ops for FJSSP."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i in range(len(machines)):
                ...
                # Score combines start time, load balance, & remaining ops.
                score = start_time + machine_load[machine] * 0.1 + remaining * 0.05
                if score < min_score:
                    min_score = score

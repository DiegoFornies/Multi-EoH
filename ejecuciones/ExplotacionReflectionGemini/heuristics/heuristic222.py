...
def heuristic(input_data):
    """Combines machine load, job completion, and SPT for FJSSP."""
    ...
    while True:
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                score = start_time + time + machine_load_factor # Minimize start, SPT, and machine load.

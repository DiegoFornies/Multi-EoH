...
def heuristic(input_data):
    ...
    Prioritizes SPT and machine load balancing to create a better initial assignment.
    """
    ...
    while available_operations:
        ...
        for job_id, op_idx in available_operations:
            ...
            for machine_idx, machine in enumerate(machines):
                ...
                # Load balance score with SPT consideration
                load_score = machine_load[machine] + processing_time

                # Prioritize machine with lowest load that leads to the earliest end time

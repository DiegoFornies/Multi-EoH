...
def heuristic(input_data):
    """Combines earliest start, SPT, and machine load."""
    ...
    while eligible_operations:
        ...
        for job, op_idx in eligible_operations:
            ...
            for i in range(len(machines)):
                ...
                score = start_time + time + machine_load[machine] #earliest start + SPT + load

                if score < min_score:
                    min_score = score
                    best_operation = (job, op_idx, machine, time, start_time, end_time)

        if best_operation:
            job, op_idx, assigned_machine, processing_time, start_time, end_time = best_operation

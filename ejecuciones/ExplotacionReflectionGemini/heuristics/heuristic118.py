...
def heuristic(input_data):
    """Combines SPT, remaining operations, and machine load for FJSSP."""
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i in range(len(machines)):
                ...
                if end_time < best_end_time:
                    ...
                    best_time = time # Shortest Processing Time
            
            remaining = remaining_operations[job_id]

            if remaining < min_remaining:
                min_remaining = remaining
                min_makespan = best_end_time
                best_operation = (job_id, op_idx, op_data, best_machine, best_start_time, best_time)
            elif remaining == min_remaining and best_end_time < min_makespan:
                min_makespan = best_end_time
                best_operation = (job_id, op_idx, op_data, best_machine, best_start_time, best_time)

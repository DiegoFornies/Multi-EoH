...
def heuristic(input_data):
    """Heuristic for FJSSP: Combines shortest processing time & earliest availability."""
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                if end_time < min_end_time:
                    ...
                    best_operation = (job_id, op_idx, processing_time)
                    best_machine = machine

        if best_operation:
            job_id, op_idx, processing_time = best_operation

...
def heuristic(input_data):
    """Schedules jobs, balancing load, SPT, and minimizing idle time."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i in range(len(machines)):
                ...
                # Incorporate SPT, machine load, and remaining operations.
                score = start_time + remaining * 0.5 + machine_load_factor * 0.1 + processing_time * 0.2 # minimize start, remining op, balance machine, time

...
def heuristic(input_data):
    """
    A heuristic for FJSSP that combines SPT and earliest machine available time.
    Prioritizes shorter processing times but considers machine availability.
    """
    ...
    while available_operations:
        ...
        for job_id, op_idx in available_operations:
            ...
            for machine_idx, machine in enumerate(machines):
                ...
                # Prioritize SPT (Shortest Processing Time) and earliest machine availability.

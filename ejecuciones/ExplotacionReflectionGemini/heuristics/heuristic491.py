...
def heuristic(input_data):
    """Combines elements from two parent heuristics."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                score = remaining + start_time + machine_load[machine]  # consider machine load
                #Add small random score to avoid same scores
                if score < min_score:
                    min_score = score

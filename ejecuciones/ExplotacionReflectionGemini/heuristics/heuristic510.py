...
def heuristic(input_data):
    """Combines SPT and least loaded machine, then improves balance."""
    ...
    while len(scheduled_operations) < sum(len(ops) for ops in jobs.values()):
        ...
        min_machine_load = float('inf') # Initialize minimum machine load
        ...
        for job_id, op_idx, op_data in operations:
            ...
            for m_idx, machine in enumerate(machines):
                ...
                # Prioritize least loaded machine at the time of scheduling.
    ...
    #Improvement by reassignment to balance load
        ...
        for op_idx in range(len(schedule[job_id])):
            ...
            for new_machine in machines:
                if new_machine != original_machine:
                    ...
                    # Update schedule based on new machine assignments

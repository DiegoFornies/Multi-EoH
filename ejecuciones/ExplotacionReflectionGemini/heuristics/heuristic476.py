        ...
        for op_idx in range(len(schedule[job_id])):
            ...
            for new_machine in machines:
                if new_machine != original_machine:
                    ...
                    op_completion_time = {j: 0 for j in range(1, n_jobs + 1)}
                    machine_ready_time = {m: 0 for m in range(n_machines)}
                    ...
                    for job_id_re in range(1, n_jobs + 1):
                        ...
                        for op_idx_re in range(len(jobs[job_id_re])):
                            ...
                            start_time = max(machine_ready_time[machine], op_completion_time[job_id_re])
                            ...
                            op_completion_time[job_id_re] = end_time

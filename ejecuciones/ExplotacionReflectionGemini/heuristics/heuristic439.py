...
def heuristic(input_data):
    """FJSSP heuristic: min makespan, balance load. Prioritize remaining ops."""
    ...
    while available_operations:
        ...
        for job_id, op_idx in available_operations:
            ...
            for machine_idx, machine in enumerate(machines):
                ...
                # Heuristic: Prioritize ops with fewer remaining ops, then earliest start
                priority = remaining_ops * 1000 + start_time  # Weight remaining ops heavily

...
def heuristic(input_data):
    """Greedy heuristic for FJSSP minimizing makespan and balancing load."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # Combining factors: makespan, load balance, remaining operations.
                score = start_time + (machine_load[machine] * 0.3) + (remaining * 0.05) # Adjusted weights

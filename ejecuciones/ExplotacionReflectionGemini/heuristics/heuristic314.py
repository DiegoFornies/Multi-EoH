...
def heuristic(input_data):
    """FJSSP heuristic: Combines SPT, machine load, idle time, and remaining operations."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # Minimize idle time, balance machine load, consider remaining operations and processing time
                score = start_time + remaining + machine_load_factor + processing_time
                if score < min_score:
                    min_score = score

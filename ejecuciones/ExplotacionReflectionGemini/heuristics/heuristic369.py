...
def heuristic(input_data):
    """Combines earliest start time, shortest processing time, and remaining operations for FJSSP."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                score = start_time + processing_time + 0.5*remaining #Earliest start, shortest time, remaining ops.

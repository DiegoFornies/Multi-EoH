...
def heuristic(input_data):
    """Schedules jobs, balancing makespan & machine load."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # Heuristic combines makespan and machine load.
                # Minimizing both results in efficient scheduling.
                score = makespan + machine_load[machine] * 0.05
                
                if score < min_makespan:
                    min_makespan = score

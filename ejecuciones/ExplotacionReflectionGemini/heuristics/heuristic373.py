...
def heuristic(input_data):
    """Combines greedy, SPT, and local search for FJSSP, balanced load."""
                    ...
                    for job_id_re in range(1, n_jobs + 1):
                        ...
                        for op_idx_re in range(len(jobs[job_id_re])):
                            if job_id_re == job_id and op_idx_re == op_idx:
                                ...
                                machine = schedule[job_id_re][current_op_idx]['Assigned Machine']
                                processing_time = schedule[job_id_re][current_op_idx]['Processing Time']
                                current_op_idx += 1

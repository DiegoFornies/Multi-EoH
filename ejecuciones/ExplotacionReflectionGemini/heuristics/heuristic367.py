...
def heuristic(input_data):
    """A hybrid heuristic minimizing makespan, idle time, and balancing load."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                score = remaining + start_time  # minimize idle time
                # score = remaining + end_time
                if score < min_score:
                    min_score = score
    ...
    # Local Search for Balance Improvement (Reassignment - similar to Parent 2)
            ...
            for new_machine in machines:
                if new_machine != original_machine:
                    ...
                    for job_id_re in range(1, n_jobs + 1):
                        ...
                        current_job_time = temp_job_completion_time[job_id_re]
                        ...
                        for op_idx_re in range(len(jobs[job_id_re])):
                            ...
                            start_time = max(temp_machine_available_time[machine], current_job_time)
                            end_time = start_time + processing_time
                        ...
                        temp_job_completion_time[job_id_re] = current_job_time

...
def heuristic(input_data):
    """Combines SPT and machine load balancing with idle time reduction."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            if best_end_time < min_end_time:
                min_end_time = best_end_time
                best_operation = (job_id, op_idx, op_data, best_machine, best_end_time - best_time)

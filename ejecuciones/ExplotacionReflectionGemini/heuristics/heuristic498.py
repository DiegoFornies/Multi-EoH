...
def heuristic(input_data):
    """Schedules jobs, prioritizing machine availability and job order."""
    ...
    while eligible_operations:
        ...
        for job, op_idx in eligible_operations:
            ...
            best_machine, min_end_time, best_ptime = -1, float('inf'), -1
            ...
            if min_end_time < earliest_end_time:
                ...
                best_operation = (job, op_idx, best_machine, best_ptime)

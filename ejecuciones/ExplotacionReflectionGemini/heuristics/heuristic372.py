...
def heuristic(input_data):
    """FJSSP heuristic: Combines SPT, load balancing, & job completion."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # Score: SPT + Load balancing + Completion Time Consideration
                score = start_time + 0.5 * machine_load[machine] + 0.2 * job_completion_time[job_id] 

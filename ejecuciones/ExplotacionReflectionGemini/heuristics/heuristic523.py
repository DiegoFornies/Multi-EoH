...
def heuristic(input_data):
    """
    A heuristic for FJSSP combining machine availability and
    remaining operations to minimize makespan.
    """
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # Combine remaining operations and start time for scoring
                score = remaining_operations[job_id] + start_time
                if score < min_score:
                    min_score = score

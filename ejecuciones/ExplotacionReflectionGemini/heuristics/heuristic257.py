...
def heuristic(input_data):
    """Combines SPT, machine load balancing, and job completion."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i in range(len(machines)):
                ...
                # Score: SPT, machine load, and job completion time
                score = start_time + 0.5 * machine_load[machine] + job_completion_time[job_id]

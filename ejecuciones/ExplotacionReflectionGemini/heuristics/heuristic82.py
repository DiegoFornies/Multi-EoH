...
def heuristic(input_data):
    """Hybrid heuristic combining idle time & job deps."""
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for machine_idx, machine in enumerate(machines):
                ...
                if idle_time < min_idle_time:
                    ...
                    best_operation = (job_id, op_idx, machine, processing_time, start_time)
        
        job_id, op_idx, machine, processing_time, start_time = best_operation

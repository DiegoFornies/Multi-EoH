...
def heuristic(input_data):
    """Combines greedy makespan with machine load balancing and local search."""
    ...
    # Local Search with combined makespan and balance
                ...
                if new_machine != original_machine:
                    ...
                    for job_id_re in range(1, n_jobs + 1):
                        ...
                        for op_idx_re in range(len(jobs[job_id_re])):
                            ...
                            temp_machine_load[assigned_machine] += processing_time_re

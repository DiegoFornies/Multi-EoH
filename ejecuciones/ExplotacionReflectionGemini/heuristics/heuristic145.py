...
def heuristic(input_data):
    """FJSSP heuristic: Combines earliest start time with shortest processing time."""
    ...
    while True:
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # score = start_time + processing_time
                score = start_time + processing_time * 0.5 #prioritizing shorter processing time
                if score < min_score:
                    min_score = score

...
def heuristic(input_data):
    """Combines SPT, machine load balancing, and job prioritization for FJSSP."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        # Prioritize jobs with shorter processing time
        eligible_operations.sort(key=lambda x: min(x[2][1])) 

...
def heuristic(input_data):
    ...
    # Phase 2: Balance Improvement (Local Search - Swap Operations within Jobs)
    def calculate_machine_load(schedule):
    ...
    def objective_functions(schedule):
        machine_load = calculate_machine_load(schedule)
    ...
    # Iterative improvement with limited iterations
    for _ in range(50):  #Limit the iterations to avoid long runtimes

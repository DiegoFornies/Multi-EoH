...
def heuristic(input_data):
    """Greedy schedule + local search (machine reassignment)."""
            ...
            for new_machine in machines:
                if new_machine != original_machine:
                    ...
                    for job_id_re in range(1, n_jobs + 1):
                        ...
                        current_job = jobs[job_id_re]
                        
                        time_so_far = 0
                        for op_idx_re in range(len(current_job)):
                            ...
                            start_time = max(temp_machine_available_time[machine], time_so_far)
                            end_time = start_time + processing_time
                            ...
                            time_so_far = end_time #job_completion_time[job_id_re]

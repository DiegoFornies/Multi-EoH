...
def heuristic(input_data):
    """Combines greedy makespan, machine load balancing and local search."""
    ...
    # Phase 1: Makespan Minimization and Load Balancing (Hybrid)
    ...
    while available_operations:
        best_operation = None
        best_machine = None
        min_score = float('inf')  # Combine makespan and load for scoring
        ...
        for job_id, op_idx in available_operations:
            ...
            for machine_idx, machine in enumerate(machines):
                ...
                # Score considers makespan and machine load
                score = end_time + 0.5 * machine_available_time[machine]

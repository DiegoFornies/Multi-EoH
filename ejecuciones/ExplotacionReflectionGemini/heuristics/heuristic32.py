...
def heuristic(input_data):
    """Schedules jobs using a greedy approach, prioritizing operations based on shortest processing time and earliest available machine."""
    ...
    operations.sort(key=lambda x: min(x[3])) # sort by smallest processing time

...
def heuristic(input_data):
    """Combines greedy makespan (SPT consideration) with local search (balance-driven reassignment) for FJSSP."""
    ...
    # Phase 1: Modified Greedy Makespan with SPT consideration
    ...
    while available_operations:
        ...
        for job_id, op_idx in available_operations:
            ...
            for machine_idx, machine in enumerate(machines):
                ...
                # SPT consideration : adding processing_time as tiebreaker
                score = end_time + processing_time/1000 #Tie breaker for jobs which are shorter
    ...
    # Phase 2: Local Search (Machine Reassignment) - Balance improvement
                ...
                if new_machine != original_machine:
                    ...
                    for job_id_re in range(1, n_jobs + 1):
                        ...
                        for op_idx_re in range(len(jobs[job_id_re])):
                            ...
                            start_time = max(temp_machine_available_time[machine], temp_job_completion_time[job_id_re], current_op_completion_time)
                            end_time = start_time + processing_time
                            ...
                            current_op_completion_time = end_time

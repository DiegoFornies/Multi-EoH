...
def heuristic(input_data):
    """A heuristic for FJSSP aiming for good balance, separation, and makespan."""
    ...
    while available_operations:
        ...
        for job_id, op_idx in available_operations:
            ...
            for machine_idx, machine in enumerate(machines):
                ...
                # Calculate priority: weighted sum of makespan impact & machine load
                priority = start_time + machine_load[machine] * 0.1 # Adjust weight (0.1)

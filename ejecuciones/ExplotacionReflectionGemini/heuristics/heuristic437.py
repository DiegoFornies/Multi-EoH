...
def heuristic(input_data):
    """Combines greedy makespan, reassignment and operation swap for balance."""
    ...
    # Phase 2 Improvement by reassignment
    for job_id in range(1, n_jobs + 1):
    ...
    # Phase 3 Improvement by swapping operations of same job to reduce balance
    for job_id in range(1, n_jobs + 1):

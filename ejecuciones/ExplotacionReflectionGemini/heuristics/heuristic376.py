...
def heuristic(input_data):
    """Combines greedy makespan with local search for balance and SPT."""
    ...
    while available_operations:
        ...
        for job_id, op_idx in available_operations:
            ...
            for machine_idx, machine in enumerate(machines):
                ...
                score = end_time + machine_load[machine] #machine load
    ...
    # Improve by reassignment based on SPT and balance consideration

...
def heuristic(input_data):
    """
    Heuristic for FJSSP: Schedules operations on machines based on earliest available time
    and shortest processing time among available machines for each operation, and prioritize
    jobs with fewer remaining operations using SPT approach.
    """

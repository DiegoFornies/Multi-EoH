...
def heuristic(input_data):
    """
    FJSSP heuristic: Prioritizes jobs with fewer remaining operations 
    and minimizes machine idle time for better scheduling.
    """
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # Minimize idle time and prioritize jobs with less remaining operations
                score = remaining + start_time
                if score < min_score:
                    min_score = score

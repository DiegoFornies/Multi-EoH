...
def heuristic(input_data):
    """Schedules jobs minimizing makespan and machine load using a combined score."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # Combined score: remaining ops + idle time + weighted machine load.
                score = remaining + start_time + 0.75 * machine_load[machine]

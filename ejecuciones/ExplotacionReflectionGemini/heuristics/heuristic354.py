...
def heuristic(input_data):
    """Combines greedy, SPT, and local search for FJSSP. Balances makespan and machine load."""
    ...
    # Phase 1: Greedy Makespan with SPT consideration
    ...
    while available_operations:
        ...
        for job_id, op_idx in available_operations:
            ...
            for machine_idx, machine in enumerate(machines):
                ...
                # Combines Makespan and machine balance consideration.
                score = end_time + 0.1 * machine_load[machine]
        ...
        if best_operation:  # Check if a best operation was found

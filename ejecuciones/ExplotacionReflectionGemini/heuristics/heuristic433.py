...
def heuristic(input_data):
    """FJSSP heuristic: Minimizes idle time and job completion time."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                #score = remaining + start_time # minimize idle time and jobs with fewer remaining tasks.
                score = start_time + end_time  #Consider both idle time and job finish time

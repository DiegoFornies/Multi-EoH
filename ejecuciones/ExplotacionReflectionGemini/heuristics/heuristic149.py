...
def heuristic(input_data):
    ...
    # Phase 1: Makespan Minimization (Greedy) - using Parent 1's approach
    ...
    # Phase 2: Balance Improvement (Local Search - Swap Operations) - adapted from Parent 1, simplified machine feasibility check

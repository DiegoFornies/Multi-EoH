...
def heuristic(input_data):
    """Combines greedy makespan, SPT, and local search for FJSSP, balanced."""
    ...
    while available_operations:
        ...
        for job_id, op_idx in available_operations:
            ...
            for machine_idx, machine in enumerate(machines):
                ...
                # Score considers machine load and remaining jobs.
                score = end_time + 0.5 * machine_load[machine] + (len(jobs[job_id]) - op_idx -1)
    ...
    # Local Search (Machine Reassignment) - Balance improvement

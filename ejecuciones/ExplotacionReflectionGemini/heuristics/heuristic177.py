...
def heuristic(input_data):
    """Schedules jobs considering machine load, job completion, and operation order."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for i, machine in enumerate(machines):
                ...
                # Prioritize operations that finish sooner, considering machine load
                score = end_time + machine_load[machine]/100 # Adding a smaller factor based on the machine_load.

        ...
        for op_idx in range(len(schedule[job_id])):
            ...
            for new_machine in machines:
                if new_machine != original_machine:
                    ...
                    if new_objectives['Balance'] < best_objectives['Balance'] or (new_objectives['Balance'] == best_objectives['Balance'] and new_objectives['Makespan'] < best_objectives['Makespan']):

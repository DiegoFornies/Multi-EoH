...
def heuristic(input_data):
    """Heuristic for FJSSP minimizing makespan, balancing load, and separation."""
    ...
    # Initial greedy assignment with load balancing
    ...
    while available_operations:
        ...
        for job_id, op_idx in available_operations:
            ...
            for machine_idx, machine in enumerate(machines):
                ...
                elif machine_load[machine] == min_load and start_time < earliest_start_time:
                    earliest_start_time = start_time
                    best_operation = (job_id, op_idx)
                    best_machine = (machine, processing_time)

...
def heuristic(input_data):
    """Heuristic for FJSSP: Min makespan, then refine for balance/separation."""
    ...
    while available_operations:
        ...
        lowest_load = float('inf') #machine load balance

...
def heuristic(input_data):
    """Combines SPT, machine load balancing, and remaining operations."""
    ...
    while any(remaining_operations[job] > 0 for job in range(1, n_jobs + 1)):
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            num_remaining = remaining_operations[job_id]
            ...
            for i in range(len(machines)):
                ...
                # Combine SPT, machine load, and remaining operations
                score = start_time + machine_load[machine] + num_remaining
                #print(f"Job: {job_id}, Op: {op_idx}, Machine: {machine}, Score: {score}")

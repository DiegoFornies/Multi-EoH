...
def heuristic(input_data):
    """Greedy heuristic combining makespan, SPT, and idle time."""
    ...
    while available_operations:
        ...
        for job_id, op_idx in available_operations:
            ...
            for machine_idx, machine in enumerate(machines):
                ...
                score = end_time + (len(jobs[job_id]) - op_idx) * 10 + start_time #Heuristic combining end_time + remaining ops and start_time

...
def heuristic(input_data):
    """Combines job prioritization and least loaded machine selection."""
    ...
    while available_operations:
        # Select operation: prioritize shorter jobs, then least loaded machine
        best_op = None
        ...
        for job, op_idx in available_operations:
            ...
            for m_idx, m in enumerate(machines):
                ...
                weighted_start_time = start_time + machine_load[m] * 0.1 #weighting factor

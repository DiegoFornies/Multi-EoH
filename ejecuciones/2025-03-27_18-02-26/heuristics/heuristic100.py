...
def heuristic(input_data):
    ...
    while available_operations:
        # Select operation based on shortest processing time first (SPT) and earliest start time
        best_op = None
        earliest_start = float('inf')
        shortest_processing_time = float('inf') # Tie breaker
        ...
        for job, op_idx in available_operations:
            ...
            elif min_start_time == earliest_start and best_time < shortest_processing_time:
                shortest_processing_time = best_time
                best_op = (job, op_idx, best_machine, best_time, min_start_time)

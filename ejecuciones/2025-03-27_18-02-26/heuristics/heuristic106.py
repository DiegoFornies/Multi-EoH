...
def heuristic(input_data):
    """Combines shortest job and least loaded machine for FJSSP."""
    ...
    while available_operations:
        ...
        for job, op_idx in available_operations:
            ...
            for m_idx, m in enumerate(machines):
                ...
                machine_load_val = machine_load[m]

                if (start_time + machine_load_val) < (min_start_time + min_machine_load):
                    min_start_time = start_time
                    best_machine = m
                    best_time = times[m_idx]
                    min_machine_load = machine_load_val

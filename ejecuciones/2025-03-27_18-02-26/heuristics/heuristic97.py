...
def heuristic(input_data):
    """Combines earliest start time and least loaded machine."""
    ...
    while available_operations:
      ...
      for job, op_idx in available_operations:
        ...
        for m_idx, m in enumerate(machines):
          ...
          makespan = start_time + times[m_idx] + machine_load[m]/100 # Bias towards lightly loaded machines
        ...
        if min_start_time < earliest_start:
          ...
          best_op = (job, op_idx, best_machine, best_time, min_start_time - machine_load[best_machine]/100)

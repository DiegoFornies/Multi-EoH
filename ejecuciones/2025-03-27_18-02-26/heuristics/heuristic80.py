...
def heuristic(input_data):
    """A heuristic for FJSSP focusing on minimizing makespan and balancing load."""
    ...
    while available_operations:
      # Prioritize operations with shortest processing time available
      best_op = None
      ...
      for job, op_idx in available_operations:
        ...
        for m_idx, m in enumerate(machines):
          ...
          if start_time < min_start_time and times[m_idx] == shortest_processing_time:

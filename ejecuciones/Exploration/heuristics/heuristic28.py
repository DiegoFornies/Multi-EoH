...
def heuristic(input_data):
    """Schedules jobs on machines to minimize makespan using a greedy approach."""
    ...
    # Keep scheduling until all jobs have been scheduled
    while any(remaining_operations[job] for job in jobs):
        ...
        for job in job_priority:  
            ...
            # Update the machine's available time and job's end time

...
def heuristic(input_data):
    """Combines SPT, machine load balancing, and job prioritization."""
    ...
    while operations:
        ...
        for job_id in job_priority:
            for job_id_op_id, op_idx, op_data in operations:
                if job_id == job_id_op_id:
                   eligible_operations.append((job_id_op_id,op_idx,op_data))
        ...
        for job_id, op_idx, op_data in eligible_operations:
            ...
            for machine_idx, machine in enumerate(available_machines):
                ...
                #Consider idle time to prioritize machine
                idle_time = start_time - machine_available_time[machine]
                impact = machine_load_impact + idle_time

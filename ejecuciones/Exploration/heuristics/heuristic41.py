...
def heuristic(input_data):
    """Schedules jobs minimizing makespan, considering machine availability and processing time."""
        ...
        for job, op_num, machines, times, _ in eligible_operations:
            for i in range(len(machines)):
                ...
                if end_time < min_end_time:
                    ...
                    best_operation = (job, op_num, machine, processing_time, start_time, end_time, job)
                    
        job, op_num, assigned_machine, processing_time, start_time, end_time,origin_job = best_operation

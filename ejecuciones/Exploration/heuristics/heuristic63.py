...
def heuristic(input_data):
    """Combines earliest start and job/machine load balancing."""
    ...
    while any(remaining_operations[job] for job in jobs):
        for job in job_priority:  
            ...
            for i, machine in enumerate(machines):
                ...
                elif end_time == earliest_end_time and (best_machine is None or machine_loads[machine] < machine_loads[best_machine]):
                    best_machine = machine
                    best_start_time = start_time
                    best_processing_time = processing_time
            ...
            job_end_time[job] = earliest_end_time

...
def heuristic(input_data):
    """
    A hybrid heuristic balancing makespan, machine load, and job separation.
    Combines machine load balancing and earliest finish time (EFT).
    """
    ...
    while scheduled_operations_count < total_operations:
        ...
        for job_id, op_index in eligible_operations:
            ...
            for m_index, machine in enumerate(machines):
                ...
                # Balancing makespan and machine load
                load_factor = machine_loads[machine]

                priority = end_time + 0.1*load_factor

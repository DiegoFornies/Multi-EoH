...
def heuristic(input_data):
    """Combines makespan & load balancing; job urgency is considered."""
    ...
    while scheduled_count < total_operations:
        ...
        for m_idx, machine in enumerate(machines):
            ...
            available_time = max(machine_available_time[machine], job_completion_time[urgent_job])
            ...
            if adjusted_end_time < best_start_time:

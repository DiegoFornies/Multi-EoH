...
def heuristic(input_data):
    """Combines predictive load balancing with dynamic priority for FJSSP."""
    ...
    while scheduled_operations_count < total_operations:
        ...
        for job_id, op_index in eligible_operations:
            ...
            for m_index, machine in enumerate(machines):
                ...
                # Predictive load balancing component
                future_load = 0
                for future_job in jobs_data:
                    if future_job != job_id:
                        for future_op_idx in range(len(jobs_data[future_job])):
                            future_operation = jobs_data[future_job][future_op_idx]
                ...
                priority = makespan_weight * makespan_impact + load_weight * load_imbalance + idle_weight * idle_time_impact + 0.001*future_load

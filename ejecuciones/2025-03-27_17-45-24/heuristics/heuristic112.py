...
def heuristic(input_data):
    """
    Combines earliest finish time with machine load balancing.
    Prioritizes operations based on urgency and machine load.
    """
    ...
    while scheduled_operations_count < total_operations:
        ...
        for job_id, op_index in eligible_operations:
            ...
            for m_index, machine in enumerate(machines):
                ...
                priority = end_time + 0.3 * urgency + 0.2 * load_factor
